...
000000000008005c <el1_entry>:
	...
	adr x0, bss_begin
   8005c:	10034260 	adr	x0, 868a8 <bss_begin>
	adr x1, bss_end
   80060:	1003d081 	adr	x1, 87a70 <bss_end>
	sub x1, x1, x0
...
setup_sp: 	
	...
	mov sp, 0x400000 // Set stack pointer so that we have 4MB of room
   ...
   800a0:	00084000 	.word	0x00084000
...
unknown:
   ...
   80904:	12027ab5 	and	w21, w21, #0xdfffffff
            uart_irq(); 
   80908:	94000c20 	bl	83988 <uart_irq>
            p1 &= (~SYSTEM_TIMER_IRQ_1);
...
{    
   ...
   8094c:	d0000024 	adrp	x4, 86000 <_binary_font_psf_start+0xac>
   80950:	911de084 	add	x4, x4, #0x778
{    
...
void kernel_main() {
   ...
   809dc:	910003fd 	mov	x29, sp
	...
	uart_init();
   809e0:	94000bf2 	bl	839a8 <uart_init>

	// Q4 quest
	/* STUDENT_TODO: your code here */
	
	init_printf(0, putc);
   809e4:	d0000021 	adrp	x1, 86000 <_binary_font_psf_start+0xac>
   809e8:	d2800000 	mov	x0, #0x0                   	// #0
   809ec:	f9441c21 	ldr	x1, [x1, #2104]
   ...
   80a34:	940007ab 	bl	828e0 <fb_init>
   80a38:	350000a0 	cbnz	w0, 80a4c <kernel_main+0x74>
	...
	/* STUDENT_TODO: your code here */
	donut_text();
   80a3c:	94000983 	bl	83048 <donut_text>
   ...
   80a5c:	52800542 	mov	w2, #0x2a                  	// #42
   80a60:	940003a0 	bl	818e0 <assertion_failed>
	donut_text();
   80a64:	94000979 	bl	83048 <donut_text>
...
0000000000081590 <init_printf>:
    stdout_putf = putf;
   81590:	b0000022 	adrp	x2, 86000 <_binary_font_psf_start+0xac>
   81594:	9122c043 	add	x3, x2, #0x8b0
   81598:	f9045841 	str	x1, [x2, #2224]
    stdout_putp = putp;
...
00000000000815a8 <tfp_printf>:
{
   ...
   815ac:	b0000028 	adrp	x8, 86000 <_binary_font_psf_start+0xac>
   815b0:	9122c10b 	add	x11, x8, #0x8b0
{
   815b4:	910003fd 	mov	x29, sp
   815b8:	f9002fe1 	str	x1, [sp, #88]
   815bc:	aa0003ea 	mov	x10, x0
    tfp_format(stdout_putp, stdout_putf, fmt, va);
   815c0:	f9445901 	ldr	x1, [x8, #2224]
    va_start(va, fmt);
...
static inline struct cpu* mycpu(void) {return &cpus[cpuid()];};
   ...
   81b8c:	b0000021 	adrp	x1, 86000 <_binary_font_psf_start+0xac>
   81b90:	52800302 	mov	w2, #0x18                  	// #24
   81b94:	f9441421 	ldr	x1, [x1, #2088]
...
void push_off(void) {
   ...
   81bb8:	a90153f3 	stp	x19, x20, [sp, #16]
    ...
    disable_irq();
    if (mycpu()->noff == 0)
   81bbc:	b0000033 	adrp	x19, 86000 <_binary_font_psf_start+0xac>
void push_off(void) {
...
static inline int intr_get(void) {return 1-is_irq_masked();}; 
   ...
   81bdc:	f9441675 	ldr	x21, [x19, #2088]
   ...
   81bf8:	f9441673 	ldr	x19, [x19, #2088]
...
void acquire(struct spinlock *lk) {
   ...
   81c5c:	b0000034 	adrp	x20, 86000 <_binary_font_psf_start+0xac>
   ...
   81c74:	f9441694 	ldr	x20, [x20, #2088]
...
int holding(struct spinlock *lk) {
   ...
   81c9c:	f9441681 	ldr	x1, [x20, #2088]
   ...
   81cc4:	b0000034 	adrp	x20, 86000 <_binary_font_psf_start+0xac>
        printf("%s ", lk->name);
...
void pop_off(void) {
   ...
   81d2c:	b0000035 	adrp	x21, 86000 <_binary_font_psf_start+0xac>
   81d30:	8b33c693 	add	x19, x20, w19, sxtw #1
   81d34:	f94416b6 	ldr	x22, [x21, #2088]
   ...
   81d50:	f94416b5 	ldr	x21, [x21, #2088]
...
void release(struct spinlock *lk) {
   ...
   81df8:	b0000021 	adrp	x1, 86000 <_binary_font_psf_start+0xac>
   81dfc:	52800302 	mov	w2, #0x18                  	// #24
   81e00:	f9441421 	ldr	x1, [x1, #2088]
   ...
   81e38:	f2a7e019 	movk	x25, #0x3f00, lsl #16
{
   ...
   81e40:	b0000033 	adrp	x19, 86000 <_binary_font_psf_start+0xac>
   81e44:	d2800014 	mov	x20, #0x0                   	// #0
   81e48:	91230273 	add	x19, x19, #0x8c0
...
0000000000081f60 <generic_timer_init>:
   ...
   81f68:	90000020 	adrp	x0, 85000 <get_el+0x61c>
	asm volatile("msr CNTP_TVAL_EL0, %0" : : "r"(intv));  // TVAL is 32bit, signed
   81f6c:	b94ee000 	ldr	w0, [x0, #3808]
...
0000000000081f78 <handle_generic_timer_irq>:
   ...
   81f78:	90000020 	adrp	x0, 85000 <get_el+0x61c>
	asm volatile("msr CNTP_TVAL_EL0, %0" : : "r"(intv));  // TVAL is 32bit, signed
   81f7c:	b94ee000 	ldr	w0, [x0, #3808]
...
00000000000820c8 <sys_timer_init>:
{
   ...
   820cc:	90000020 	adrp	x0, 86000 <_binary_font_psf_start+0xac>
   820d0:	d0000001 	adrp	x1, 84000 <vectors>
{
   820d4:	910003fd 	mov	x29, sp
	initlock(&timerlock, "timer"); 
   820d8:	f9441000 	ldr	x0, [x0, #2080]
   ...
   820e8:	90000020 	adrp	x0, 86000 <_binary_font_psf_start+0xac>
   820ec:	52806401 	mov	w1, #0x320                 	// #800
   820f0:	91230000 	add	x0, x0, #0x8c0
...
int ktimer_start(unsigned delayms, TKernelTimerHandler *handler, 
   ...
   82100:	a90363f7 	stp	x23, x24, [sp, #48]
	int ret;
	acquire(&timerlock); 
   82104:	90000037 	adrp	x23, 86000 <_binary_font_psf_start+0xac>
   82108:	90000038 	adrp	x24, 86000 <_binary_font_psf_start+0xac>
		void *para, void *context) {
   8210c:	f90023f9 	str	x25, [sp, #64]
   82110:	2a0003f9 	mov	w25, w0
	acquire(&timerlock); 
   82114:	f94412e0 	ldr	x0, [x23, #2080]
		void *para, void *context) {
   ...
   82134:	91230300 	add	x0, x24, #0x8c0
   ...
   82188:	91230318 	add	x24, x24, #0x8c0
   ...
   821a8:	97ffff1c 	bl	81e18 <adjust_sys_timer>
	...
	release(&timerlock); 
   821ac:	f94412e0 	ldr	x0, [x23, #2080]
...
int ktimer_cancel(int t) {
   ...
   82240:	b9400022 	ldr	w2, [x1]
	...
	cur = current_counter();
	acquire(&timerlock); 
   82244:	90000034 	adrp	x20, 86000 <_binary_font_psf_start+0xac>
	return ((unsigned long) get32(TIMER_CHI) << 32) | get32(TIMER_CLO);
   82248:	b9400001 	ldr	w1, [x0]
	acquire(&timerlock); 
   8224c:	f9441294 	ldr	x20, [x20, #2080]
	return ((unsigned long) get32(TIMER_CHI) << 32) | get32(TIMER_CLO);
...
int ktimer_cancel(int t) {
   ...
   82268:	90000021 	adrp	x1, 86000 <_binary_font_psf_start+0xac>
   8226c:	8b33c013 	add	x19, x0, w19, sxtw
   82270:	91230021 	add	x1, x1, #0x8c0
   ...
   822f8:	b9400000 	ldr	w0, [x0]
{
   ...
   82320:	b9000003 	str	w3, [x0]
	...
	acquire(&timerlock); 
   82324:	90000034 	adrp	x20, 86000 <_binary_font_psf_start+0xac>
	return ((unsigned long) get32(TIMER_CHI) << 32) | get32(TIMER_CLO);
   82328:	b9400053 	ldr	w19, [x2]
   8232c:	b9400021 	ldr	w1, [x1]
	acquire(&timerlock); 
   82330:	f9441280 	ldr	x0, [x20, #2080]
	return ((unsigned long) get32(TIMER_CHI) << 32) | get32(TIMER_CLO);
   ...
   82340:	90000020 	adrp	x0, 86000 <_binary_font_psf_start+0xac>
   82344:	91230000 	add	x0, x0, #0x8c0
...
timers[t].elapseat = 0; /* STUDENT_TODO: replace this */
   ...
   82374:	97fffea9 	bl	81e18 <adjust_sys_timer>
	release(&timerlock);
   82378:	f9441280 	ldr	x0, [x20, #2080]
}
...
int mbox_call(unsigned char ch) {
   823a8:	a9bc7bfd 	stp	x29, x30, [sp, #-64]!
...
int mbox_call(unsigned char ch) {
   ...
   823b8:	a90363f7 	stp	x23, x24, [sp, #48]
    unsigned int r = (((unsigned int)((unsigned long)&mbox) & ~0xF) | (ch & 0xF));
   823bc:	90000038 	adrp	x24, 86000 <_binary_font_psf_start+0xac>
int mbox_call(unsigned char ch) {
   823c0:	a90153f3 	stp	x19, x20, [sp, #16]
    unsigned int r = (((unsigned int)((unsigned long)&mbox) & ~0xF) | (ch & 0xF));
   823c4:	12000c14 	and	w20, w0, #0xf
   823c8:	f9440f00 	ldr	x0, [x24, #2072]
int mbox_call(unsigned char ch) {
   823cc:	a9025bf5 	stp	x21, x22, [sp, #32]
    unsigned int r = (((unsigned int)((unsigned long)&mbox) & ~0xF) | (ch & 0xF));
   823d0:	2a000294 	orr	w20, w20, w0
    r = BUS_ADDRESS(r); 
   823d4:	32020694 	orr	w20, w20, #0xc0000000
    do { asm volatile("nop"); } while (*MBOX_STATUS & MBOX_FULL);
   823d8:	d503201f 	nop
   823dc:	b9400020 	ldr	w0, [x1]
   823e0:	37ffffc0 	tbnz	w0, #31, 823d8 <mbox_call+0x30>
    __asm__ volatile ("dmb sy" ::: "memory");    // mem barrier, ensuring msg in mem
   823e4:	d5033fbf 	dmb	sy

    /* write the address of our message to the mailbox with channel identifier */
    *MBOX_WRITE = r; 
   823e8:	d2971400 	mov	x0, #0xb8a0                	// #47264
            V("r is 0x%x", r); 
   ...
   823ec:	d0000015 	adrp	x21, 84000 <vectors>
    *MBOX_WRITE = r; 
   823f0:	f2a7e000 	movk	x0, #0x3f00, lsl #16
        do { asm volatile("nop"); } while (*MBOX_STATUS & MBOX_EMPTY);
   823f4:	d2971313 	mov	x19, #0xb898                	// #47256
        if (r == *MBOX_READ) {
   823f8:	d2971017 	mov	x23, #0xb880                	// #47232
            W("got an irrelevant msg. bug?"); 
   823fc:	913be2b5 	add	x21, x21, #0xef8
        do { asm volatile("nop"); } while (*MBOX_STATUS & MBOX_EMPTY);
   82400:	f2a7e013 	movk	x19, #0x3f00, lsl #16
        if (r == *MBOX_READ) {
   82404:	f2a7e017 	movk	x23, #0x3f00, lsl #16
            W("got an irrelevant msg. bug?"); 
   82408:	d0000016 	adrp	x22, 84000 <vectors>
    *MBOX_WRITE = r; 
   8240c:	b9000014 	str	w20, [x0]
        do { asm volatile("nop"); } while (*MBOX_STATUS & MBOX_EMPTY);
   82410:	d503201f 	nop
   82414:	b9400260 	ldr	w0, [x19]
   82418:	37f7ffc0 	tbnz	w0, #30, 82410 <mbox_call+0x68>
        if (r == *MBOX_READ) {
   8241c:	b94002e3 	ldr	w3, [x23]
            W("got an irrelevant msg. bug?"); 
   82420:	aa1503e1 	mov	x1, x21
   82424:	913ca2c0 	add	x0, x22, #0xf28
   82428:	52800842 	mov	w2, #0x42                  	// #66
        if (r == *MBOX_READ) {
   8242c:	6b14007f 	cmp	w3, w20
   82430:	54000060 	b.eq	8243c <mbox_call+0x94>  // b.none
            W("got an irrelevant msg. bug?"); 
   82434:	97fffc5d 	bl	815a8 <tfp_printf>
    while (1) {
   82438:	17fffff6 	b	82410 <mbox_call+0x68>
            if (mbox[1] != MBOX_RESPONSE) I("mbox[1] is %08x", mbox[1]);            
   8243c:	f9440f00 	ldr	x0, [x24, #2072]
   82440:	52b00001 	mov	w1, #0x80000000            	// #-2147483648
   82444:	b9400402 	ldr	w2, [x0, #4]
   82448:	6b01005f 	cmp	w2, w1
   8244c:	54000100 	b.eq	8246c <mbox_call+0xc4>  // b.none
   82450:	b9400403 	ldr	w3, [x0, #4]
   82454:	d0000001 	adrp	x1, 84000 <vectors>
   82458:	d0000000 	adrp	x0, 84000 <vectors>
   8245c:	913be021 	add	x1, x1, #0xef8
   82460:	913c0000 	add	x0, x0, #0xf00
   82464:	528007e2 	mov	w2, #0x3f                  	// #63
   82468:	97fffc50 	bl	815a8 <tfp_printf>
            return mbox[1] == MBOX_RESPONSE;
   8246c:	f9440f18 	ldr	x24, [x24, #2072]
   82470:	52b00000 	mov	w0, #0x80000000            	// #-2147483648
        }
    }
    return 0;
}
   82474:	a94153f3 	ldp	x19, x20, [sp, #16]
            return mbox[1] == MBOX_RESPONSE;
   82478:	b9400701 	ldr	w1, [x24, #4]
}
   8247c:	a9425bf5 	ldp	x21, x22, [sp, #32]
            return mbox[1] == MBOX_RESPONSE;
   82480:	6b00003f 	cmp	w1, w0
   82484:	1a9f17e0 	cset	w0, eq  // eq = none
}
   82488:	a94363f7 	ldp	x23, x24, [sp, #48]
   8248c:	a8c47bfd 	ldp	x29, x30, [sp], #64
   82490:	d65f03c0 	ret
   82494:	d503201f 	nop

0000000000082498 <fb_detect_scr_dim>:
 * Return: 0 on success.
 *
...
int fb_detect_scr_dim(uint *w, uint *h) {
   ...
   824a0:	52800063 	mov	w3, #0x3                   	// #3
int fb_detect_scr_dim(uint *w, uint *h) {
   824a4:	910003fd 	mov	x29, sp
   824a8:	a90153f3 	stp	x19, x20, [sp, #16]
    mbox[0] = 8*4;     // size of the whole buf that follows
   824ac:	90000033 	adrp	x19, 86000 <_binary_font_psf_start+0xac>
        mbox[2] = 0x40003;     // rls framebuffer
   824b0:	72a00083 	movk	w3, #0x4, lsl #16
    mbox[0] = 8*4;     // size of the whole buf that follows
   824b4:	f9440e73 	ldr	x19, [x19, #2072]
int fb_detect_scr_dim(uint *w, uint *h) {
   824b8:	f90013f5 	str	x21, [sp, #32]
        mbox[3] = 8;           // total buf size
   824bc:	52800102 	mov	w2, #0x8                   	// #8
int fb_detect_scr_dim(uint *w, uint *h) {
   824c0:	aa0003f4 	mov	x20, x0
   824c4:	aa0103f5 	mov	x21, x1
   ...
   824d8:	b9000e62 	str	w2, [x19, #12]
        mbox[4] = 0;           // req para size
   824dc:	b900127f 	str	wzr, [x19, #16]
        mbox[5] = 0;           // resp: width
   824e0:	b900167f 	str	wzr, [x19, #20]
        mbox[6] = 0;           // resp: height
   824e4:	b9001a7f 	str	wzr, [x19, #24]
    mbox[7] = MBOX_TAG_LAST;
   824e8:	b9001e7f 	str	wzr, [x19, #28]
    if(!mbox_call(MBOX_CH_PROP)) {
   824ec:	97ffffaf 	bl	823a8 <mbox_call>
   824f0:	34000220 	cbz	w0, 82534 <fb_detect_scr_dim+0x9c>
   ...
   824f8:	d0000001 	adrp	x1, 84000 <vectors>
   824fc:	b9000280 	str	w0, [x20]
   82500:	913be021 	add	x1, x1, #0xef8
   82504:	52801542 	mov	w2, #0xaa                  	// #170
   82508:	d0000000 	adrp	x0, 84000 <vectors>
   8250c:	b9401a64 	ldr	w4, [x19, #24]
   82510:	913e2000 	add	x0, x0, #0xf88
   82514:	b90002a4 	str	w4, [x21]
   82518:	b9400283 	ldr	w3, [x20]
   8251c:	97fffc23 	bl	815a8 <tfp_printf>
    return 0; 
   82520:	52800000 	mov	w0, #0x0                   	// #0
}
   82524:	a94153f3 	ldp	x19, x20, [sp, #16]
   82528:	f94013f5 	ldr	x21, [sp, #32]
   8252c:	a8c37bfd 	ldp	x29, x30, [sp], #48
   82530:	d65f03c0 	ret
        E("failed to get screen dim");
   82534:	d0000001 	adrp	x1, 84000 <vectors>
   82538:	d0000000 	adrp	x0, 84000 <vectors>
   8253c:	913be021 	add	x1, x1, #0xef8
   82540:	913d6000 	add	x0, x0, #0xf58
   82544:	528014c2 	mov	w2, #0xa6                  	// #166
   82548:	97fffc18 	bl	815a8 <tfp_printf>
        return -1;
   8254c:	12800000 	mov	w0, #0xffffffff            	// #-1
   82550:	17fffff5 	b	82524 <fb_detect_scr_dim+0x8c>
   82554:	d503201f 	nop

0000000000082558 <fb_set_voffsets>:
/* 
 * Set virt offset
 * Caller must hold mboxlock
 * Return 0 on success 
...
int fb_set_voffsets(int offsetx, int offsety) {
   82558:	a9bd7bfd 	stp	x29, x30, [sp, #-48]!

    mbox[0] = 8*4;
   8255c:	52800404 	mov	w4, #0x20                  	// #32
    mbox[1] = MBOX_REQUEST;
    
    mbox[2] = 0x48009; 
   82560:	52900123 	mov	w3, #0x8009                	// #32777
int fb_set_voffsets(int offsetx, int offsety) {
   82564:	910003fd 	mov	x29, sp
   82568:	a9025bf5 	stp	x21, x22, [sp, #32]
    mbox[0] = 8*4;
   8256c:	90000036 	adrp	x22, 86000 <_binary_font_psf_start+0xac>
    mbox[2] = 0x48009; 
   82570:	72a00083 	movk	w3, #0x4, lsl #16
int fb_set_voffsets(int offsetx, int offsety) {
   82574:	a90153f3 	stp	x19, x20, [sp, #16]
    mbox[3] = 8;
   82578:	52800102 	mov	w2, #0x8                   	// #8
int fb_set_voffsets(int offsetx, int offsety) {
   8257c:	2a0003f4 	mov	w20, w0
    mbox[0] = 8*4;
   82580:	f9440ed3 	ldr	x19, [x22, #2072]
int fb_set_voffsets(int offsetx, int offsety) {
   82584:	2a0103f5 	mov	w21, w1
    ...
    if(!mbox_call(MBOX_CH_PROP)) {
   82588:	2a0203e0 	mov	w0, w2
    mbox[0] = 8*4;
   8258c:	b9000264 	str	w4, [x19]
    mbox[1] = MBOX_REQUEST;
   82590:	b900067f 	str	wzr, [x19, #4]
    mbox[2] = 0x48009; 
   82594:	b9000a63 	str	w3, [x19, #8]
    mbox[3] = 8;
   82598:	b9000e62 	str	w2, [x19, #12]
    mbox[4] = 8;
   8259c:	b9001262 	str	w2, [x19, #16]
    mbox[5] =  offsetx;           //FrameBufferInfo.x_offset
   825a0:	b9001674 	str	w20, [x19, #20]
    mbox[6] =  offsety;           //FrameBufferInfo.y.offset    
   825a4:	b9001a61 	str	w1, [x19, #24]
    mbox[7] = MBOX_TAG_LAST;
   825a8:	b9001e7f 	str	wzr, [x19, #28]
    if(!mbox_call(MBOX_CH_PROP)) {
   825ac:	97ffff7f 	bl	823a8 <mbox_call>
   825b0:	34000320 	cbz	w0, 82614 <fb_set_voffsets+0xbc>
        E("failed to set virt offsets, requested x=%d y=%d", offsetx, offsety);
        return -1;
    }     
     if (mbox[5] != offsetx || mbox[6] != offsety) {
   825b4:	b9401660 	ldr	w0, [x19, #20]
   825b8:	6b00029f 	cmp	w20, w0
   825bc:	54000121 	b.ne	825e0 <fb_set_voffsets+0x88>  // b.any
   825c0:	b9401a61 	ldr	w1, [x19, #24]
     ...
     V("set OK: offsetx %u offsety %u res: offsetx %u offsety %u", 
            offsetx, offsety, mbox[5], mbox[6]);
     return 0; 
   825c4:	52800000 	mov	w0, #0x0                   	// #0
     if (mbox[5] != offsetx || mbox[6] != offsety) {
   825c8:	6b0102bf 	cmp	w21, w1
   825cc:	540000a1 	b.ne	825e0 <fb_set_voffsets+0x88>  // b.any
}
   825d0:	a94153f3 	ldp	x19, x20, [sp, #16]
   825d4:	a9425bf5 	ldp	x21, x22, [sp, #32]
   825d8:	a8c37bfd 	ldp	x29, x30, [sp], #48
   825dc:	d65f03c0 	ret
        E("failed set: offsetx %u offsety %u res: offsetx %u offsety %u", 
   825e0:	f9440ed6 	ldr	x22, [x22, #2072]
   825e4:	2a1503e4 	mov	w4, w21
   825e8:	2a1403e3 	mov	w3, w20
   825ec:	d0000001 	adrp	x1, 84000 <vectors>
   825f0:	f0000000 	adrp	x0, 85000 <get_el+0x61c>
   825f4:	913be021 	add	x1, x1, #0xef8
   825f8:	b94016c5 	ldr	w5, [x22, #20]
   825fc:	91000000 	add	x0, x0, #0x0
   82600:	b9401ac6 	ldr	w6, [x22, #24]
   82604:	528018a2 	mov	w2, #0xc5                  	// #197
   82608:	97fffbe8 	bl	815a8 <tfp_printf>
        return -1;     
   8260c:	12800000 	mov	w0, #0xffffffff            	// #-1
   82610:	17fffff0 	b	825d0 <fb_set_voffsets+0x78>
        E("failed to set virt offsets, requested x=%d y=%d", offsetx, offsety);
   82614:	2a1503e4 	mov	w4, w21
   82618:	2a1403e3 	mov	w3, w20
   8261c:	d0000001 	adrp	x1, 84000 <vectors>
   82620:	d0000000 	adrp	x0, 84000 <vectors>
   82624:	913be021 	add	x1, x1, #0xef8
   82628:	913ee000 	add	x0, x0, #0xfb8
   8262c:	52801822 	mov	w2, #0xc1                  	// #193
   82630:	97fffbde 	bl	815a8 <tfp_printf>
        return -1;
   82634:	12800000 	mov	w0, #0xffffffff            	// #-1
   82638:	17ffffe6 	b	825d0 <fb_set_voffsets+0x78>
   8263c:	d503201f 	nop

0000000000082640 <fb_fini>:
    return ret; 
}
...
int fb_fini(void) {
   82640:	a9be7bfd 	stp	x29, x30, [sp, #-32]!
   82644:	910003fd 	mov	x29, sp
   82648:	a90153f3 	stp	x19, x20, [sp, #16]
    int ret = 0;

    acquire(&mboxlock);
    if (!the_fb.fb || !the_fb.size) {
   8264c:	f0000013 	adrp	x19, 85000 <get_el+0x61c>
    acquire(&mboxlock);
   82650:	90000034 	adrp	x20, 86000 <_binary_font_psf_start+0xac>
   82654:	911fe280 	add	x0, x20, #0x7f8
   82658:	97fffd7a 	bl	81c40 <acquire>
    if (!the_fb.fb || !the_fb.size) {
   8265c:	f9477660 	ldr	x0, [x19, #3816]
   82660:	b4000460 	cbz	x0, 826ec <fb_fini+0xac>
   82664:	913ba261 	add	x1, x19, #0xee8
   82668:	b9403422 	ldr	w2, [x1, #52]
   8266c:	34000402 	cbz	w2, 826ec <fb_fini+0xac>
        ret = -1;
        goto out;
    }
   ...
   82670:	52800001 	mov	w1, #0x0                   	// #0
   82674:	97fffca7 	bl	81910 <memset>
#endif

    mbox[0] = 6 * 4;        // size of the whole buf that follows
   82678:	90000021 	adrp	x1, 86000 <_binary_font_psf_start+0xac>
   8267c:	52800303 	mov	w3, #0x18                  	// #24
    mbox[1] = MBOX_REQUEST; // cpu->gpu request

    mbox[2] = 0x48001; // rls framebuffer
   82680:	52900022 	mov	w2, #0x8001                	// #32769
    ...
    if (!mbox_call(MBOX_CH_PROP))
   82684:	52800100 	mov	w0, #0x8                   	// #8
    mbox[0] = 6 * 4;        // size of the whole buf that follows
   82688:	f9440c21 	ldr	x1, [x1, #2072]
    mbox[2] = 0x48001; // rls framebuffer
   8268c:	72a00082 	movk	w2, #0x4, lsl #16
    mbox[0] = 6 * 4;        // size of the whole buf that follows
   82690:	b9000023 	str	w3, [x1]
    mbox[1] = MBOX_REQUEST; // cpu->gpu request
   82694:	b900043f 	str	wzr, [x1, #4]
    mbox[2] = 0x48001; // rls framebuffer
   82698:	b9000822 	str	w2, [x1, #8]
    mbox[3] = 0;       // total buf size
   8269c:	b9000c3f 	str	wzr, [x1, #12]
    mbox[4] = 0;       // req para size
   826a0:	b900103f 	str	wzr, [x1, #16]
    mbox[5] = MBOX_TAG_LAST;
   826a4:	b900143f 	str	wzr, [x1, #20]
    if (!mbox_call(MBOX_CH_PROP))
   826a8:	97ffff40 	bl	823a8 <mbox_call>
   826ac:	34000120 	cbz	w0, 826d0 <fb_fini+0x90>
    ...
    // }
    the_fb.fb = 0;
   826b0:	f907767f 	str	xzr, [x19, #3816]
    int ret = 0;
   826b4:	52800013 	mov	w19, #0x0                   	// #0
out:
    release(&mboxlock);
   826b8:	911fe280 	add	x0, x20, #0x7f8
   826bc:	97fffdb9 	bl	81da0 <release>
    return ret;
}
   826c0:	2a1303e0 	mov	w0, w19
   826c4:	a94153f3 	ldp	x19, x20, [sp, #16]
   826c8:	a8c27bfd 	ldp	x29, x30, [sp], #32
   826cc:	d65f03c0 	ret
        I("failed to rls fb with GPU.");
   826d0:	d0000001 	adrp	x1, 84000 <vectors>
   826d4:	f0000000 	adrp	x0, 85000 <get_el+0x61c>
   826d8:	913be021 	add	x1, x1, #0xef8
   826dc:	91014000 	add	x0, x0, #0x50
   826e0:	52802a22 	mov	w2, #0x151                 	// #337
   826e4:	97fffbb1 	bl	815a8 <tfp_printf>
   826e8:	17fffff2 	b	826b0 <fb_fini+0x70>
        ret = -1;
   826ec:	12800013 	mov	w19, #0xffffffff            	// #-1
   826f0:	17fffff2 	b	826b8 <fb_fini+0x78>
   826f4:	d503201f 	nop

00000000000826f8 <fb_print>:
    ...
    while (*s) {
   826f8:	39400043 	ldrb	w3, [x2]
    unsigned pitch = the_fb.pitch;
   826fc:	f0000004 	adrp	x4, 85000 <get_el+0x61c>
   82700:	913ba085 	add	x5, x4, #0xee8
    unsigned char *fb = the_fb.fb;
   82704:	f947748f 	ldr	x15, [x4, #3816]
    unsigned pitch = the_fb.pitch;
   82708:	b94018ab 	ldr	w11, [x5, #24]
    while (*s) {
   8270c:	34000923 	cbz	w3, 82830 <fb_print+0x138>
void fb_print(int *x, int *y, char *s) {
   82710:	a9bd7bfd 	stp	x29, x30, [sp, #-48]!
        /* get offset of the glyph. Need to adjust this to support unicode table */
        unsigned char *glyph = (unsigned char *)&_binary_font_psf_start +
                               font->headersize + (*((unsigned char *)s) < font->numglyph ? *s : 0) * font->bytesperglyph;
   82714:	90000024 	adrp	x4, 86000 <_binary_font_psf_start+0xac>
            } else {
                // display a character
                for (j = 0; j < font->height; j++) {
                    ...
                    line = offs;
                    mask = 1 << (font->width - 1);
   82718:	5280002e 	mov	w14, #0x1                   	// #1
void fb_print(int *x, int *y, char *s) {
   8271c:	910003fd 	mov	x29, sp
                               font->headersize + (*((unsigned char *)s) < font->numglyph ? *s : 0) * font->bytesperglyph;
   82720:	f9442084 	ldr	x4, [x4, #2112]
   82724:	910011f1 	add	x17, x15, #0x4
                    for (i = 0; i < font->width; i++) {
                        // if bit set, we use white color, otherwise black
                        *((unsigned int *)(fb + line)) = ((int)*glyph) & mask ? 0xFFFFFF : 0;
   82728:	12bfe008 	mov	w8, #0xffffff              	// #16777215
void fb_print(int *x, int *y, char *s) {
   8272c:	a90153f3 	stp	x19, x20, [sp, #16]
        unsigned char *glyph = (unsigned char *)&_binary_font_psf_start +
   82730:	aa0403f4 	mov	x20, x4
                               font->headersize + (*((unsigned char *)s) < font->numglyph ? *s : 0) * font->bytesperglyph;
   82734:	b940088d 	ldr	w13, [x4, #8]
   82738:	b940109e 	ldr	w30, [x4, #16]
   8273c:	b9401492 	ldr	w18, [x4, #20]
   82740:	2a0d03ed 	mov	w13, w13
        int i, j, line, mask, bytesperline = (font->width + 7) / 8;
   82744:	b9401c8a 	ldr	w10, [x4, #28]
                for (j = 0; j < font->height; j++) {
   82748:	b9401889 	ldr	w9, [x4, #24]
        int i, j, line, mask, bytesperline = (font->width + 7) / 8;
   8274c:	11001d4c 	add	w12, w10, #0x7
                    mask = 1 << (font->width - 1);
   82750:	51000550 	sub	w16, w10, #0x1
   82754:	0b0e0153 	add	w19, w10, w14
void fb_print(int *x, int *y, char *s) {
   82758:	a9025bf5 	stp	x21, x22, [sp, #32]
   8275c:	53037d8c 	lsr	w12, w12, #3
                    mask = 1 << (font->width - 1);
   82760:	1ad021ce 	lsl	w14, w14, w16
   82764:	14000009 	b	82788 <fb_print+0x90>
            if (*s == '\n') {
   82768:	7100287f 	cmp	w3, #0xa
   8276c:	54000281 	b.ne	827bc <fb_print+0xc4>  // b.any
                *x = 0;
   82770:	b900001f 	str	wzr, [x0]
                *y += font->height;
   82774:	b9400023 	ldr	w3, [x1]
   82778:	0b090063 	add	w3, w3, w9
   8277c:	b9000023 	str	w3, [x1]
    while (*s) {
   82780:	38401c43 	ldrb	w3, [x2, #1]!
   82784:	34000143 	cbz	w3, 827ac <fb_print+0xb4>
        unsigned char *glyph = (unsigned char *)&_binary_font_psf_start +
   82788:	1b127c66 	mul	w6, w3, w18
   8278c:	6b1e007f 	cmp	w3, w30
   82790:	8b0d00c6 	add	x6, x6, x13
   82794:	9a8d30c6 	csel	x6, x6, x13, cc  // cc = lo, ul, last
        if (*s == '\r') {
   82798:	7100347f 	cmp	w3, #0xd
   8279c:	54fffe61 	b.ne	82768 <fb_print+0x70>  // b.any
            *x = 0;
   827a0:	b900001f 	str	wzr, [x0]
    while (*s) {
   827a4:	38401c43 	ldrb	w3, [x2, #1]!
   827a8:	35ffff03 	cbnz	w3, 82788 <fb_print+0x90>
                *x += (font->width + 1);
            }
        // next character
        s++;
   ...
   827ac:	a94153f3 	ldp	x19, x20, [sp, #16]
   827b0:	a9425bf5 	ldp	x21, x22, [sp, #32]
   827b4:	a8c37bfd 	ldp	x29, x30, [sp], #48
   827b8:	d65f03c0 	ret
        int offs = (*y * pitch) + (*x * 4);
   827bc:	b9400003 	ldr	w3, [x0]
                for (j = 0; j < font->height; j++) {
   827c0:	34000329 	cbz	w9, 82824 <fb_print+0x12c>
        int offs = (*y * pitch) + (*x * 4);
   827c4:	b9400035 	ldr	w21, [x1]
   827c8:	531e7463 	lsl	w3, w3, #2
        unsigned char *glyph = (unsigned char *)&_binary_font_psf_start +
   827cc:	8b1400c6 	add	x6, x6, x20
                for (j = 0; j < font->height; j++) {
   827d0:	52800016 	mov	w22, #0x0                   	// #0
        int offs = (*y * pitch) + (*x * 4);
   827d4:	1b150d75 	madd	w21, w11, w21, w3
                    for (i = 0; i < font->width; i++) {
   827d8:	340001aa 	cbz	w10, 8280c <fb_print+0x114>
   827dc:	93407ea3 	sxtw	x3, w21
                    mask = 1 << (font->width - 1);
   827e0:	2a0e03e4 	mov	w4, w14
   827e4:	8b304867 	add	x7, x3, w16, uxtw #2
   827e8:	8b0301e3 	add	x3, x15, x3
   827ec:	8b1100e7 	add	x7, x7, x17
                        *((unsigned int *)(fb + line)) = ((int)*glyph) & mask ? 0xFFFFFF : 0;
   827f0:	394000c5 	ldrb	w5, [x6]
   827f4:	6a0400bf 	tst	w5, w4
                        mask >>= 1;
   827f8:	13017c84 	asr	w4, w4, #1
                        *((unsigned int *)(fb + line)) = ((int)*glyph) & mask ? 0xFFFFFF : 0;
   827fc:	1a9f1105 	csel	w5, w8, wzr, ne  // ne = any
   82800:	b8004465 	str	w5, [x3], #4
                    for (i = 0; i < font->width; i++) {
   82804:	eb07007f 	cmp	x3, x7
   82808:	54ffff41 	b.ne	827f0 <fb_print+0xf8>  // b.any
                for (j = 0; j < font->height; j++) {
   8280c:	110006d6 	add	w22, w22, #0x1
                    glyph += bytesperline;
   82810:	8b0c00c6 	add	x6, x6, x12
                for (j = 0; j < font->height; j++) {
   82814:	6b0902df 	cmp	w22, w9
   82818:	0b0b02b5 	add	w21, w21, w11
   8281c:	54fffde1 	b.ne	827d8 <fb_print+0xe0>  // b.any
   82820:	b9400003 	ldr	w3, [x0]
                *x += (font->width + 1);
   82824:	0b130063 	add	w3, w3, w19
   82828:	b9000003 	str	w3, [x0]
   8282c:	17ffffd5 	b	82780 <fb_print+0x88>
   82830:	d65f03c0 	ret
   82834:	d503201f 	nop

0000000000082838 <fb_showpicture>:
...
void fb_showpicture()
{
   82838:	a9bb7bfd 	stp	x29, x30, [sp, #-80]!
   ...
   8283c:	52800ec2 	mov	w2, #0x76                  	// #118
    unsigned int img_fb_width = the_fb.vwidth < IMG_WIDTH ? the_fb.vwidth : IMG_WIDTH; 
   82840:	52800e80 	mov	w0, #0x74                  	// #116
{
   82844:	910003fd 	mov	x29, sp
   82848:	a90153f3 	stp	x19, x20, [sp, #16]
    unsigned int img_fb_height = the_fb.vheight < IMG_HEIGHT ? the_fb.vheight : IMG_HEIGHT; 
   8284c:	f0000013 	adrp	x19, 85000 <get_el+0x61c>
   82850:	913ba263 	add	x3, x19, #0xee8
{
   82854:	a9025bf5 	stp	x21, x22, [sp, #32]
    unsigned int img_fb_height = the_fb.vheight < IMG_HEIGHT ? the_fb.vheight : IMG_HEIGHT; 
   82858:	b9401461 	ldr	w1, [x3, #20]
    unsigned int img_fb_width = the_fb.vwidth < IMG_WIDTH ? the_fb.vwidth : IMG_WIDTH; 
   8285c:	b9401063 	ldr	w3, [x3, #16]
    unsigned int img_fb_height = the_fb.vheight < IMG_HEIGHT ? the_fb.vheight : IMG_HEIGHT; 
   82860:	6b02003f 	cmp	w1, w2
   ...
   82864:	b9003fff 	str	wzr, [sp, #60]
    unsigned int img_fb_height = the_fb.vheight < IMG_HEIGHT ? the_fb.vheight : IMG_HEIGHT; 
   82868:	1a829022 	csel	w2, w1, w2, ls  // ls = plast
    unsigned int img_fb_width = the_fb.vwidth < IMG_WIDTH ? the_fb.vwidth : IMG_WIDTH; 
   8286c:	6b00007f 	cmp	w3, w0
   82870:	1a809060 	csel	w0, w3, w0, ls  // ls = plast
    for(y=0;y<img_fb_height;y++) {
   82874:	34000081 	cbz	w1, 82884 <fb_showpicture+0x4c>
   82878:	7100007f 	cmp	w3, #0x0
   8287c:	1a9f1000 	csel	w0, w0, wzr, ne  // ne = any
   82880:	29070be0 	stp	w0, w2, [sp, #56]
    // show text strings
    // quest: OS logo. 
   ...
   82884:	913ba273 	add	x19, x19, #0xee8
    fb_print(&x, &y, "UVA OS");    
   82888:	9100f3f5 	add	x21, sp, #0x3c
   8288c:	9100e3f4 	add	x20, sp, #0x38
   82890:	aa1503e1 	mov	x1, x21
   82894:	aa1403e0 	mov	x0, x20
   82898:	f0000002 	adrp	x2, 85000 <get_el+0x61c>
   8289c:	91020042 	add	x2, x2, #0x80
   828a0:	97ffff96 	bl	826f8 <fb_print>
    sprintf(res, " %dx%d", the_fb.width, the_fb.height); // debug info 
   828a4:	29410e62 	ldp	w2, w3, [x19, #8]
   828a8:	910103f6 	add	x22, sp, #0x40
   828ac:	aa1603e0 	mov	x0, x22
   828b0:	f0000001 	adrp	x1, 85000 <get_el+0x61c>
   828b4:	91022021 	add	x1, x1, #0x88
   828b8:	97fffba0 	bl	81738 <tfp_sprintf>
    fb_print(&x, &y, res);
   828bc:	aa1603e2 	mov	x2, x22
   828c0:	aa1503e1 	mov	x1, x21
   828c4:	aa1403e0 	mov	x0, x20
   828c8:	97ffff8c 	bl	826f8 <fb_print>
}
   828cc:	a94153f3 	ldp	x19, x20, [sp, #16]
   828d0:	a9425bf5 	ldp	x21, x22, [sp, #32]
   828d4:	a8c57bfd 	ldp	x29, x30, [sp], #80
   828d8:	d65f03c0 	ret
   828dc:	d503201f 	nop

00000000000828e0 <fb_init>:
int fb_init(void) {
   828e0:	d10143ff 	sub	sp, sp, #0x50
   828e4:	a9017bfd 	stp	x29, x30, [sp, #16]
   828e8:	910043fd 	add	x29, sp, #0x10
   828ec:	a90463f7 	stp	x23, x24, [sp, #64]
    mbox[0] = 35 * 4;       // size of the whole buf that follows
   828f0:	90000037 	adrp	x23, 86000 <_binary_font_psf_start+0xac>
int fb_init(void) {
   828f4:	a90253f3 	stp	x19, x20, [sp, #32]
   828f8:	a9035bf5 	stp	x21, x22, [sp, #48]
    acquire(&mboxlock);
   828fc:	90000036 	adrp	x22, 86000 <_binary_font_psf_start+0xac>
   82900:	911fe2c0 	add	x0, x22, #0x7f8
   82904:	97fffccf 	bl	81c40 <acquire>
    mbox[5] = fbs->width;  //(val) FrameBufferInfo.width
   82908:	f0000015 	adrp	x21, 85000 <get_el+0x61c>
    mbox[0] = 35 * 4;       // size of the whole buf that follows
   8290c:	f9440ef3 	ldr	x19, [x23, #2072]
   82910:	52801182 	mov	w2, #0x8c                  	// #140
    mbox[5] = fbs->width;  //(val) FrameBufferInfo.width
   82914:	913ba2b4 	add	x20, x21, #0xee8
    mbox[2] = 0x48003;     // set phy width & height
   82918:	52900060 	mov	w0, #0x8003                	// #32771
   8291c:	72a00080 	movk	w0, #0x4, lsl #16
    mbox[3] = 8;           // total buf size of this tag
   82920:	52800101 	mov	w1, #0x8                   	// #8
    mbox[0] = 35 * 4;       // size of the whole buf that follows
   82924:	b9000262 	str	w2, [x19]
    mbox[7] = 0x48004; // set virt width & height
   82928:	52900089 	mov	w9, #0x8004                	// #32772
    mbox[1] = MBOX_REQUEST; // cpu->gpu request
   8292c:	b900067f 	str	wzr, [x19, #4]
    mbox[7] = 0x48004; // set virt width & height
   82930:	72a00089 	movk	w9, #0x4, lsl #16
    mbox[2] = 0x48003;     // set phy width & height
   82934:	b9000a60 	str	w0, [x19, #8]
    mbox[12] = 0x48009; // set virt offset
   82938:	52900128 	mov	w8, #0x8009                	// #32777
    mbox[3] = 8;           // total buf size of this tag
   8293c:	b9000e61 	str	w1, [x19, #12]
    mbox[12] = 0x48009; // set virt offset
   82940:	72a00088 	movk	w8, #0x4, lsl #16
    mbox[5] = fbs->width;  //(val) FrameBufferInfo.width
   82944:	b9400a80 	ldr	w0, [x20, #8]
    mbox[17] = 0x48005; // set depth
   82948:	529000a7 	mov	w7, #0x8005                	// #32773
    mbox[4] = 8;           // req val size (needed?), to be overwritten as resp val size
   8294c:	b9001261 	str	w1, [x19, #16]
    mbox[17] = 0x48005; // set depth
   82950:	72a00087 	movk	w7, #0x4, lsl #16
    mbox[5] = fbs->width;  //(val) FrameBufferInfo.width
   82954:	b9001660 	str	w0, [x19, #20]
    mbox[18] = 4;
   82958:	52800082 	mov	w2, #0x4                   	// #4
    mbox[6] = fbs->height; //(val) FrameBufferInfo.height
   8295c:	b9400e80 	ldr	w0, [x20, #12]
    mbox[21] = 0x48006; // set pixel order
   82960:	529000c6 	mov	w6, #0x8006                	// #32774
    mbox[6] = fbs->height; //(val) FrameBufferInfo.height
   82964:	b9001a60 	str	w0, [x19, #24]
    mbox[21] = 0x48006; // set pixel order
   82968:	72a00086 	movk	w6, #0x4, lsl #16
    mbox[7] = 0x48004; // set virt width & height
   8296c:	b9001e69 	str	w9, [x19, #28]
    mbox[25] = 0x40001; // get framebuffer, gets alignment on request
   82970:	52800025 	mov	w5, #0x1                   	// #1
    mbox[8] = 8;
   82974:	b9002261 	str	w1, [x19, #32]
    mbox[25] = 0x40001; // get framebuffer, gets alignment on request
   82978:	72a00085 	movk	w5, #0x4, lsl #16
    mbox[10] = fbs->vwidth;  // FrameBufferInfo.virtual_width
   8297c:	b9401289 	ldr	w9, [x20, #16]
    mbox[28] = 4096; // req: alignment; resp: FrameBufferInfo.pointer
   82980:	52820004 	mov	w4, #0x1000                	// #4096
    mbox[9] = 8;
   82984:	b9002661 	str	w1, [x19, #36]
    mbox[30] = 0x40008; // get pitch
   82988:	52800103 	mov	w3, #0x8                   	// #8
    mbox[10] = fbs->vwidth;  // FrameBufferInfo.virtual_width
   8298c:	b9002a69 	str	w9, [x19, #40]
    mbox[30] = 0x40008; // get pitch
   82990:	72a00083 	movk	w3, #0x4, lsl #16
    mbox[11] = fbs->vheight; // FrameBufferInfo.virtual_height
   82994:	b9401689 	ldr	w9, [x20, #20]
    if(mbox_call(MBOX_CH_PROP) 
   82998:	2a0103e0 	mov	w0, w1
    mbox[11] = fbs->vheight; // FrameBufferInfo.virtual_height
   8299c:	b9002e69 	str	w9, [x19, #44]
    mbox[12] = 0x48009; // set virt offset
   829a0:	b9003268 	str	w8, [x19, #48]
    mbox[13] = 8;
   829a4:	b9003661 	str	w1, [x19, #52]
    mbox[15] = fbs->offsetx;
   829a8:	b9402e88 	ldr	w8, [x20, #44]
    mbox[14] = 8;
   829ac:	b9003a61 	str	w1, [x19, #56]
    mbox[15] = fbs->offsetx;
   829b0:	b9003e68 	str	w8, [x19, #60]
    mbox[16] = fbs->offsety;
   829b4:	b9403288 	ldr	w8, [x20, #48]
   829b8:	b9004268 	str	w8, [x19, #64]
    mbox[17] = 0x48005; // set depth
   829bc:	b9004667 	str	w7, [x19, #68]
    mbox[18] = 4;
   829c0:	b9004a62 	str	w2, [x19, #72]
    mbox[20] = fbs->depth;
   829c4:	b9402687 	ldr	w7, [x20, #36]
    mbox[19] = 4;
   829c8:	b9004e62 	str	w2, [x19, #76]
    mbox[20] = fbs->depth;
   829cc:	b9005267 	str	w7, [x19, #80]
    mbox[21] = 0x48006; // set pixel order
   829d0:	b9005666 	str	w6, [x19, #84]
    mbox[22] = 4;
   829d4:	b9005a62 	str	w2, [x19, #88]
    mbox[23] = 4;
   829d8:	b9005e62 	str	w2, [x19, #92]
    mbox[24] = fbs->isrgb; // RGB, not BGR preferably
   829dc:	b9402a86 	ldr	w6, [x20, #40]
   829e0:	b9006266 	str	w6, [x19, #96]
    mbox[25] = 0x40001; // get framebuffer, gets alignment on request
   829e4:	b9006665 	str	w5, [x19, #100]
    mbox[26] = 8;
   829e8:	b9006a61 	str	w1, [x19, #104]
    mbox[27] = 8;    // should be 4?? (req para size)
   829ec:	b9006e61 	str	w1, [x19, #108]
    mbox[28] = 4096; // req: alignment; resp: FrameBufferInfo.pointer
   829f0:	b9007264 	str	w4, [x19, #112]
    mbox[29] = 0;    // resp: FrameBufferInfo.size
   829f4:	b900767f 	str	wzr, [x19, #116]
    mbox[30] = 0x40008; // get pitch
   829f8:	b9007a63 	str	w3, [x19, #120]
    mbox[31] = 4;
   829fc:	b9007e62 	str	w2, [x19, #124]
    mbox[32] = 4;
   82a00:	b9008262 	str	w2, [x19, #128]
    mbox[33] = 0; // FrameBufferInfo.pitch
   82a04:	b900867f 	str	wzr, [x19, #132]
    mbox[34] = MBOX_TAG_LAST; // the end of tag seq
   82a08:	b9008a7f 	str	wzr, [x19, #136]
    if(mbox_call(MBOX_CH_PROP) 
   82a0c:	97fffe67 	bl	823a8 <mbox_call>
   82a10:	340009a0 	cbz	w0, 82b44 <fb_init+0x264>
        && mbox[20]==fbs->depth /*depth*/ 
   82a14:	b9405261 	ldr	w1, [x19, #80]
   82a18:	b9402680 	ldr	w0, [x20, #36]
   82a1c:	6b00003f 	cmp	w1, w0
   82a20:	54000921 	b.ne	82b44 <fb_init+0x264>  // b.any
        && mbox[28]!=0 /*framebuf*/) {
   82a24:	b9407260 	ldr	w0, [x19, #112]
   82a28:	340008e0 	cbz	w0, 82b44 <fb_init+0x264>
        mbox[28]&=0x3FFFFFFF;  
   82a2c:	b9407260 	ldr	w0, [x19, #112]
   82a30:	d0000018 	adrp	x24, 84000 <vectors>
        if(fbs->pitch * fbs->vheight > mbox[29])  // possible that pitch*vheight < actual allocation
   82a34:	b9401a88 	ldr	w8, [x20, #24]
        mbox[28]&=0x3FFFFFFF;  
   82a38:	12007400 	and	w0, w0, #0x3fffffff
   82a3c:	b9007260 	str	w0, [x19, #112]
        fbs->width=mbox[5];
   82a40:	b9401664 	ldr	w4, [x19, #20]
        fbs->vwidth=mbox[10];
   82a44:	b9402a66 	ldr	w6, [x19, #40]
        fbs->vheight=mbox[11];        
   82a48:	b9402e67 	ldr	w7, [x19, #44]
        fbs->depth=mbox[20]; 
   82a4c:	b9405261 	ldr	w1, [x19, #80]
        fbs->isrgb=mbox[24];     // channel order
   82a50:	b9406269 	ldr	w9, [x19, #96]
        if(fbs->pitch * fbs->vheight > mbox[29])  // possible that pitch*vheight < actual allocation
   82a54:	b9407662 	ldr	w2, [x19, #116]
   82a58:	1b087ce0 	mul	w0, w7, w8
        fbs->width=mbox[5];
   82a5c:	b9000a84 	str	w4, [x20, #8]
        fbs->vheight=mbox[11];        
   82a60:	29021e86 	stp	w6, w7, [x20, #16]
        fbs->isrgb=mbox[24];     // channel order
   82a64:	2904a681 	stp	w1, w9, [x20, #36]
        if(fbs->pitch * fbs->vheight > mbox[29])  // possible that pitch*vheight < actual allocation
   82a68:	6b02001f 	cmp	w0, w2
   82a6c:	54000328 	b.hi	82ad0 <fb_init+0x1f0>  // b.pmore
        I("OK. fb pa: 0x%08x w %u h %u vw %u vh %u pitch %u isrgb %u", 
   82a70:	f9440ef7 	ldr	x23, [x23, #2072]
        fbs->size = PGROUNDUP(fbs->pitch * fbs->vheight);  // roundup b/c we'll reserve pages for it
   82a74:	913ba2b5 	add	x21, x21, #0xee8
   82a78:	113ffc00 	add	w0, w0, #0xfff
        I("OK. fb pa: 0x%08x w %u h %u vw %u vh %u pitch %u isrgb %u", 
   82a7c:	913be301 	add	x1, x24, #0xef8
   82a80:	52802422 	mov	w2, #0x121                 	// #289
   82a84:	b94072e3 	ldr	w3, [x23, #112]
   82a88:	b9400ea5 	ldr	w5, [x21, #12]
   82a8c:	b90003e8 	str	w8, [sp]
        fbs->size = PGROUNDUP(fbs->pitch * fbs->vheight);  // roundup b/c we'll reserve pages for it
   82a90:	12144c08 	and	w8, w0, #0xfffff000
        I("OK. fb pa: 0x%08x w %u h %u vw %u vh %u pitch %u isrgb %u", 
   82a94:	b9000be9 	str	w9, [sp, #8]
   82a98:	f0000000 	adrp	x0, 85000 <get_el+0x61c>
   82a9c:	91032000 	add	x0, x0, #0xc8
        fbs->size = PGROUNDUP(fbs->pitch * fbs->vheight);  // roundup b/c we'll reserve pages for it
   82aa0:	b90036a8 	str	w8, [x21, #52]
        I("OK. fb pa: 0x%08x w %u h %u vw %u vh %u pitch %u isrgb %u", 
   82aa4:	97fffac1 	bl	815a8 <tfp_printf>
    release(&mboxlock); 
   82aa8:	911fe2c0 	add	x0, x22, #0x7f8
   82aac:	97fffcbd 	bl	81da0 <release>
    if (ret==0 && once)
   82ab0:	b9403aa0 	ldr	w0, [x21, #56]
   82ab4:	35000360 	cbnz	w0, 82b20 <fb_init+0x240>
}
   82ab8:	a9417bfd 	ldp	x29, x30, [sp, #16]
   82abc:	a94253f3 	ldp	x19, x20, [sp, #32]
   82ac0:	a9435bf5 	ldp	x21, x22, [sp, #48]
   82ac4:	a94463f7 	ldp	x23, x24, [sp, #64]
   82ac8:	910143ff 	add	sp, sp, #0x50
   82acc:	d65f03c0 	ret
            {W("pitch %d x vheight %d!= mbox[29] %u", fbs->pitch, fbs->vheight, mbox[29]);BUG();}
   82ad0:	b9407665 	ldr	w5, [x19, #116]
   82ad4:	2a0703e4 	mov	w4, w7
   82ad8:	2a0803e3 	mov	w3, w8
   82adc:	913be313 	add	x19, x24, #0xef8
   82ae0:	aa1303e1 	mov	x1, x19
   82ae4:	528023e2 	mov	w2, #0x11f                 	// #287
   82ae8:	f0000000 	adrp	x0, 85000 <get_el+0x61c>
   82aec:	91024000 	add	x0, x0, #0x90
   82af0:	97fffaae 	bl	815a8 <tfp_printf>
   82af4:	aa1303e1 	mov	x1, x19
   82af8:	d0000000 	adrp	x0, 84000 <vectors>
   82afc:	528023e2 	mov	w2, #0x11f                 	// #287
   82b00:	912ac000 	add	x0, x0, #0xab0
   82b04:	97fffb77 	bl	818e0 <assertion_failed>
   82b08:	29421e86 	ldp	w6, w7, [x20, #16]
   82b0c:	b9401a88 	ldr	w8, [x20, #24]
   82b10:	b9400a84 	ldr	w4, [x20, #8]
   82b14:	b9402a89 	ldr	w9, [x20, #40]
   82b18:	1b077d00 	mul	w0, w8, w7
   82b1c:	17ffffd5 	b	82a70 <fb_init+0x190>
        {fb_showpicture(); once=0;}
   82b20:	97ffff46 	bl	82838 <fb_showpicture>
   82b24:	b9003abf 	str	wzr, [x21, #56]
    return 0;
   82b28:	52800000 	mov	w0, #0x0                   	// #0
}
   82b2c:	a9417bfd 	ldp	x29, x30, [sp, #16]
   82b30:	a94253f3 	ldp	x19, x20, [sp, #32]
   82b34:	a9435bf5 	ldp	x21, x22, [sp, #48]
   82b38:	a94463f7 	ldp	x23, x24, [sp, #64]
   82b3c:	910143ff 	add	sp, sp, #0x50
   82b40:	d65f03c0 	ret
        E("Unable to set scr res to %d x %d\n", fbs->width, fbs->height);
   82b44:	913ba2b3 	add	x19, x21, #0xee8
   82b48:	d0000001 	adrp	x1, 84000 <vectors>
   82b4c:	f0000000 	adrp	x0, 85000 <get_el+0x61c>
   82b50:	913be021 	add	x1, x1, #0xef8
   82b54:	91046000 	add	x0, x0, #0x118
   82b58:	528024a2 	mov	w2, #0x125                 	// #293
   82b5c:	29411263 	ldp	w3, w4, [x19, #8]
   82b60:	97fffa92 	bl	815a8 <tfp_printf>
        return -2; 
   82b64:	12800020 	mov	w0, #0xfffffffe            	// #-2
   82b68:	17ffffd4 	b	82ab8 <fb_init+0x1d8>
   82b6c:	00000000 	udf	#0

0000000000082b70 <canvas_init>:
...
static void canvas_init(void) {
   82b70:	a9bf7bfd 	stp	x29, x30, [sp, #-16]!
   82b74:	910003fd 	mov	x29, sp
    fb_fini();
   82b78:	97fffeb2 	bl	82640 <fb_fini>
    // acquire(&mboxlock);      //it's a test. so no lock

    the_fb.width = NN;
   82b7c:	90000020 	adrp	x0, 86000 <_binary_font_psf_start+0xac>
   82b80:	d2805001 	mov	x1, #0x280                 	// #640
   82b84:	f2c05001 	movk	x1, #0x280, lsl #32
   82b88:	f9441800 	ldr	x0, [x0, #2096]
    the_fb.height = NN;

    the_fb.vwidth = NN;
   82b8c:	a9008401 	stp	x1, x1, [x0, #8]
    the_fb.vheight = NN;

    if (fb_init() != 0)
   82b90:	97ffff54 	bl	828e0 <fb_init>
   82b94:	35000060 	cbnz	w0, 82ba0 <canvas_init+0x30>
        BUG();
}
   82b98:	a8c17bfd 	ldp	x29, x30, [sp], #16
   82b9c:	d65f03c0 	ret
   82ba0:	a8c17bfd 	ldp	x29, x30, [sp], #16
        BUG();
   82ba4:	f0000001 	adrp	x1, 85000 <get_el+0x61c>
   82ba8:	d0000000 	adrp	x0, 84000 <vectors>
   82bac:	91058021 	add	x1, x1, #0x160
   82bb0:	912ac000 	add	x0, x0, #0xab0
   82bb4:	528004a2 	mov	w2, #0x25                  	// #37
   82bb8:	17fffb4a 	b	818e0 <assertion_failed>
   82bbc:	d503201f 	nop

0000000000082bc0 <draw_frame>:
static int _;
...
static int draw_frame(TKernelTimerHandle hTimer, void *param, void *context) {    
   82bc0:	a9b97bfd 	stp	x29, x30, [sp, #-112]!
    memset(b, 0, 1760);  // text buffer 0: black bkgnd
   82bc4:	90000020 	adrp	x0, 86000 <_binary_font_psf_start+0xac>
   82bc8:	912f8003 	add	x3, x0, #0xbe0
static int draw_frame(TKernelTimerHandle hTimer, void *param, void *context) {    
   82bcc:	910003fd 	mov	x29, sp
    memset(b, 0, 1760);  // text buffer 0: black bkgnd
   82bd0:	aa0303e0 	mov	x0, x3
   82bd4:	5280dc02 	mov	w2, #0x6e0                 	// #1760
   82bd8:	52800001 	mov	w1, #0x0                   	// #0
static int draw_frame(TKernelTimerHandle hTimer, void *param, void *context) {    
   82bdc:	a90153f3 	stp	x19, x20, [sp, #16]
   82be0:	a9025bf5 	stp	x21, x22, [sp, #32]
   82be4:	52801ff6 	mov	w22, #0xff                  	// #255
   82be8:	a90363f7 	stp	x23, x24, [sp, #48]
    memset(z, 127, 1760); // z buffer
   82bec:	911b8078 	add	x24, x3, #0x6e0
   ...
   82bf0:	528cccf7 	mov	w23, #0x6667                	// #26215
static int draw_frame(TKernelTimerHandle hTimer, void *param, void *context) {    
   82bf4:	a9046bf9 	stp	x25, x26, [sp, #64]
                lumince = lumince<0? 0 : lumince/5; 
   82bf8:	72acccd7 	movk	w23, #0x6666, lsl #16
    int sj = 0, cj = 1024;
   82bfc:	52808019 	mov	w25, #0x400                 	// #1024
static int draw_frame(TKernelTimerHandle hTimer, void *param, void *context) {    
   82c00:	a90573fb 	stp	x27, x28, [sp, #80]
                lumince = (((-cA * x7 - cB * ((-sA * x7 >> 10) + x2) - ci * (cj * sB >> 10)) >> 10) - x5); 
   82c04:	52800b5c 	mov	w28, #0x5a                  	// #90
    int sj = 0, cj = 1024;
   82c08:	5280001b 	mov	w27, #0x0                   	// #0
    memset(z, 127, 1760); // z buffer
   82c0c:	f90037e3 	str	x3, [sp, #104]
    memset(b, 0, 1760);  // text buffer 0: black bkgnd
   82c10:	97fffb40 	bl	81910 <memset>
    memset(z, 127, 1760); // z buffer
   82c14:	52800fe1 	mov	w1, #0x7f                  	// #127
   82c18:	aa1803e0 	mov	x0, x24
   82c1c:	5280dc02 	mov	w2, #0x6e0                 	// #1760
   82c20:	97fffb3c 	bl	81910 <memset>
                x2 = cA * sj >> 10,
   82c24:	f94037e3 	ldr	x3, [sp, #104]
                x4 = R1 * x2 - (sA * x3 >> 10),
   82c28:	f0000000 	adrp	x0, 85000 <get_el+0x61c>
   82c2c:	f0000001 	adrp	x1, 85000 <get_el+0x61c>
   82c30:	913c9000 	add	x0, x0, #0xf24
   ...
   82c38:	52a00612 	mov	w18, #0x300000              	// #3145728
                x4 = R1 * x2 - (sA * x3 >> 10),
   82c3c:	b94f243e 	ldr	w30, [x1, #3876]
                x2 = cA * sj >> 10,
   82c40:	b94dc073 	ldr	w19, [x3, #3520]
                x = 25 + 30 * (cB * x1 - sB * x4) / x6,
   82c44:	b940040e 	ldr	w14, [x0, #4]
                lumince = (((-cA * x7 - cB * ((-sA * x7 >> 10) + x2) - ci * (cj * sB >> 10)) >> 10) - x5); 
   82c48:	4b1e03f4 	neg	w20, w30
                x = 25 + 30 * (cB * x1 - sB * x4) / x6,
   82c4c:	b94dc46b 	ldr	w11, [x3, #3524]
                lumince = (((-cA * x7 - cB * ((-sA * x7 >> 10) + x2) - ci * (cj * sB >> 10)) >> 10) - x5); 
   82c50:	4b1303f5 	neg	w21, w19
                x5 = sA * sj >> 10,
   82c54:	1b1b7fc7 	mul	w7, w30, w27
        int si = 0, ci = 1024; // sine and cosine of angle i
   82c58:	52808000 	mov	w0, #0x400                 	// #1024
                x2 = cA * sj >> 10,
   82c5c:	1b1b7e68 	mul	w8, w19, w27
   82c60:	11200329 	add	w9, w25, #0x800
                lumince = (((-cA * x7 - cB * ((-sA * x7 >> 10) + x2) - ci * (cj * sB >> 10)) >> 10) - x5); 
   82c64:	1b197dca 	mul	w10, w14, w25
                x6 = K2 + R1 * 1024 * x5 + cA * x3,
   82c68:	121654ec 	and	w12, w7, #0xfffffc00
   82c6c:	1154018c 	add	w12, w12, #0x500, lsl #12
                x5 = sA * sj >> 10,
   82c70:	130a7ce7 	asr	w7, w7, #10
                x2 = cA * sj >> 10,
   82c74:	130a7d08 	asr	w8, w8, #10
   82c78:	2a0003ed 	mov	w13, w0
                lumince = (((-cA * x7 - cB * ((-sA * x7 >> 10) + x2) - ci * (cj * sB >> 10)) >> 10) - x5); 
   82c7c:	130a7d4a 	asr	w10, w10, #10
   82c80:	52802886 	mov	w6, #0x144                 	// #324
        int si = 0, ci = 1024; // sine and cosine of angle i
   82c84:	52800001 	mov	w1, #0x0                   	// #0
                x3 = si * x0 >> 10,
   82c88:	1b097c23 	mul	w3, w1, w9
            R(5, 8, ci, si) // rotate i
   82c8c:	0b010830 	add	w16, w1, w1, lsl #2
                x1 = ci * x0 >> 10,
   82c90:	1b097db1 	mul	w17, w13, w9
            R(5, 8, ci, si) // rotate i
   82c94:	0b0d09a2 	add	w2, w13, w13, lsl #2
   82c98:	4b9021b0 	sub	w16, w13, w16, asr #8
                x7 = cj * si >> 10,
   82c9c:	4b012c64 	sub	w4, w3, w1, lsl #11
                x3 = si * x0 >> 10,
   82ca0:	130a7c63 	asr	w3, w3, #10
            R(5, 8, ci, si) // rotate i
   82ca4:	0b822021 	add	w1, w1, w2, asr #8
                x1 = ci * x0 >> 10,
   82ca8:	130a7e31 	asr	w17, w17, #10
                x7 = cj * si >> 10,
   82cac:	130a7c84 	asr	w4, w4, #10
            R(5, 8, ci, si) // rotate i
   82cb0:	1b10ca02 	msub	w2, w16, w16, w18
                x4 = R1 * x2 - (sA * x3 >> 10),
   82cb4:	1b037fc5 	mul	w5, w30, w3
                x = 25 + 30 * (cB * x1 - sB * x4) / x6,
   82cb8:	1b117d6f 	mul	w15, w11, w17
                lumince = (((-cA * x7 - cB * ((-sA * x7 >> 10) + x2) - ci * (cj * sB >> 10)) >> 10) - x5); 
   82cbc:	1b047e80 	mul	w0, w20, w4
                x4 = R1 * x2 - (sA * x3 >> 10),
   82cc0:	4b852905 	sub	w5, w8, w5, asr #10
            R(5, 8, ci, si) // rotate i
   82cc4:	1b018822 	msub	w2, w1, w1, w2
                y = 12 + 15 * (cB * x4 + sB * x1) / x6,
   82cc8:	1b117dd1 	mul	w17, w14, w17
                lumince = (((-cA * x7 - cB * ((-sA * x7 >> 10) + x2) - ci * (cj * sB >> 10)) >> 10) - x5); 
   82ccc:	0b802900 	add	w0, w8, w0, asr #10
   82cd0:	1b047ea4 	mul	w4, w21, w4
                x = 25 + 30 * (cB * x1 - sB * x4) / x6,
   82cd4:	1b05bdcf 	msub	w15, w14, w5, w15
            R(5, 8, ci, si) // rotate i
   82cd8:	130b7c42 	asr	w2, w2, #11
                y = 12 + 15 * (cB * x4 + sB * x1) / x6,
   82cdc:	1b054565 	madd	w5, w11, w5, w17
                lumince = (((-cA * x7 - cB * ((-sA * x7 >> 10) + x2) - ci * (cj * sB >> 10)) >> 10) - x5); 
   82ce0:	1b0b9000 	msub	w0, w0, w11, w4
   82ce4:	52800004 	mov	w4, #0x0                   	// #0
                x = 25 + 30 * (cB * x1 - sB * x4) / x6,
   82ce8:	531c6df1 	lsl	w17, w15, #4
                lumince = (((-cA * x7 - cB * ((-sA * x7 >> 10) + x2) - ci * (cj * sB >> 10)) >> 10) - x5); 
   82cec:	1b0d8140 	msub	w0, w10, w13, w0
                x = 25 + 30 * (cB * x1 - sB * x4) / x6,
   82cf0:	4b0f022f 	sub	w15, w17, w15
                x6 = K2 + R1 * 1024 * x5 + cA * x3,
   82cf4:	1b033263 	madd	w3, w19, w3, w12
                y = 12 + 15 * (cB * x4 + sB * x1) / x6,
   82cf8:	531c6cb1 	lsl	w17, w5, #4
            R(5, 8, ci, si) // rotate i
   82cfc:	1b107c4d 	mul	w13, w2, w16
                y = 12 + 15 * (cB * x4 + sB * x1) / x6,
   82d00:	4b050225 	sub	w5, w17, w5
                lumince = (((-cA * x7 - cB * ((-sA * x7 >> 10) + x2) - ci * (cj * sB >> 10)) >> 10) - x5); 
   82d04:	130a7c00 	asr	w0, w0, #10
            R(5, 8, ci, si) // rotate i
   82d08:	1b017c41 	mul	w1, w2, w1
                x = 25 + 30 * (cB * x1 - sB * x4) / x6,
   82d0c:	531f79ef 	lsl	w15, w15, #1
                lumince = lumince<0? 0 : lumince/5; 
   82d10:	6b070000 	subs	w0, w0, w7
            R(5, 8, ci, si) // rotate i
   82d14:	130a7dad 	asr	w13, w13, #10
                y = 12 + 15 * (cB * x4 + sB * x1) / x6,
   82d18:	1ac30ca5 	sdiv	w5, w5, w3
                lumince = lumince<0? 0 : lumince/5; 
   82d1c:	540000c4 	b.mi	82d34 <draw_frame+0x174>  // b.first
   82d20:	9b377c04 	smull	x4, w0, w23
   82d24:	9361fc84 	asr	x4, x4, #33
   82d28:	4b807c84 	sub	w4, w4, w0, asr #31
   82d2c:	7103fc9f 	cmp	w4, #0xff
   82d30:	1a96d084 	csel	w4, w4, w22, le
            if (22 > y && y > 0 && x > 0 && 80 > x && zz < z[o]) { // fxl: z depth will control visibility
   82d34:	11002ca0 	add	w0, w5, #0xb
            R(5, 8, ci, si) // rotate i
   82d38:	130a7c21 	asr	w1, w1, #10
            if (22 > y && y > 0 && x > 0 && 80 > x && zz < z[o]) { // fxl: z depth will control visibility
   82d3c:	7100501f 	cmp	w0, #0x14
   82d40:	54000208 	b.hi	82d80 <draw_frame+0x1c0>  // b.pmore
                x = 25 + 30 * (cB * x1 - sB * x4) / x6,
   82d44:	1ac30def 	sdiv	w15, w15, w3
                y = 12 + 15 * (cB * x4 + sB * x1) / x6,
   82d48:	110030a2 	add	w2, w5, #0xc
            signed char zz = (x6 - K2) >> 15;
   82d4c:	51540063 	sub	w3, w3, #0x500, lsl #12
            int o = x + 80 * y; // fxl: 80 chars per row
   82d50:	0b020842 	add	w2, w2, w2, lsl #2
            signed char zz = (x6 - K2) >> 15;
   82d54:	934f5863 	sbfx	x3, x3, #15, #8
                x = 25 + 30 * (cB * x1 - sB * x4) / x6,
   82d58:	110065e0 	add	w0, w15, #0x19
            if (22 > y && y > 0 && x > 0 && 80 > x && zz < z[o]) { // fxl: z depth will control visibility
   82d5c:	110061ef 	add	w15, w15, #0x18
   82d60:	710139ff 	cmp	w15, #0x4e
   82d64:	540000e8 	b.hi	82d80 <draw_frame+0x1c0>  // b.pmore
            int o = x + 80 * y; // fxl: 80 chars per row
   82d68:	0b021002 	add	w2, w0, w2, lsl #4
            if (22 > y && y > 0 && x > 0 && 80 > x && zz < z[o]) { // fxl: z depth will control visibility
   82d6c:	38e2cb00 	ldrsb	w0, [x24, w2, sxtw]
   82d70:	6b03001f 	cmp	w0, w3
   82d74:	5400006d 	b.le	82d80 <draw_frame+0x1c0>
                z[o] = zz;
   82d78:	3822cb03 	strb	w3, [x24, w2, sxtw]
                b[o] = lumince;                    
   82d7c:	3822cb44 	strb	w4, [x26, w2, sxtw]
        for (int i = 0; i < 324; i++) {
   82d80:	710004c6 	subs	w6, w6, #0x1
   82d84:	54fff821 	b.ne	82c88 <draw_frame+0xc8>  // b.any
        }
        R(9, 7, cj, sj) // rotate j
   82d88:	0b1b0f60 	add	w0, w27, w27, lsl #3
   82d8c:	0b190f21 	add	w1, w25, w25, lsl #3
    for (int j = 0; j < 90; j++) {
   82d90:	7100079c 	subs	w28, w28, #0x1
        R(9, 7, cj, sj) // rotate j
   82d94:	4b801f39 	sub	w25, w25, w0, asr #7
   82d98:	0b811f7b 	add	w27, w27, w1, asr #7
   82d9c:	1b19cb20 	msub	w0, w25, w25, w18
   82da0:	1b1b8360 	msub	w0, w27, w27, w0
   82da4:	130b7c00 	asr	w0, w0, #11
   82da8:	1b197c19 	mul	w25, w0, w25
   82dac:	1b1b7c00 	mul	w0, w0, w27
   82db0:	130a7f39 	asr	w25, w25, #10
   82db4:	130a7c1b 	asr	w27, w0, #10
    for (int j = 0; j < 90; j++) {
   82db8:	54fff4e1 	b.ne	82c54 <draw_frame+0x94>  // b.any
    }
    R(5, 7, cA, sA);
    R(5, 8, cB, sB);
   82dbc:	0b0e09c0 	add	w0, w14, w14, lsl #2
    R(5, 7, cA, sA);
   82dc0:	0b1e0bc1 	add	w1, w30, w30, lsl #2
    R(5, 8, cB, sB);
   82dc4:	0b0b0962 	add	w2, w11, w11, lsl #2
    R(5, 7, cA, sA);
   82dc8:	0b130a63 	add	w3, w19, w19, lsl #2
    R(5, 8, cB, sB);
   82dcc:	4b80216b 	sub	w11, w11, w0, asr #8
    R(5, 7, cA, sA);
   82dd0:	4b811e73 	sub	w19, w19, w1, asr #7
    R(5, 8, cB, sB);
   82dd4:	0b8221ce 	add	w14, w14, w2, asr #8
    R(5, 7, cA, sA);
   82dd8:	90000020 	adrp	x0, 86000 <_binary_font_psf_start+0xac>
   82ddc:	0b831fde 	add	w30, w30, w3, asr #7
   82de0:	912f800c 	add	x12, x0, #0xbe0
   82de4:	f0000000 	adrp	x0, 85000 <get_el+0x61c>
   82de8:	913c900d 	add	x13, x0, #0xf24
    R(5, 8, cB, sB);
   82dec:	1b0bc960 	msub	w0, w11, w11, w18
            if (x < 50) {
   ...
   82df0:	9000002a 	adrp	x10, 86000 <_binary_font_psf_start+0xac>
    R(5, 7, cA, sA);
   82df4:	1b13ca69 	msub	w9, w19, w19, w18
                setpixel(the_fb.fb, xx, yy, the_fb.pitch, clr);
   82df8:	529999a5 	mov	w5, #0xcccd                	// #52429
    R(5, 8, cB, sB);
   82dfc:	1b0e81c0 	msub	w0, w14, w14, w0
        if (k % 80) {
   82e00:	52866664 	mov	w4, #0x3333                	// #13107
    R(5, 7, cA, sA);
   82e04:	1b1ea7c9 	msub	w9, w30, w30, w9
                PIXEL clr = int2rgb(b[k]); // to a color spectrum
   82e08:	aa0c03e7 	mov	x7, x12
                setpixel(the_fb.fb, xx, yy, the_fb.pitch, clr);
   82e0c:	f944194a 	ldr	x10, [x10, #2096]
    R(5, 8, cB, sB);
   82e10:	130b7c00 	asr	w0, w0, #11
    R(5, 7, cA, sA);
   82e14:	130b7d29 	asr	w9, w9, #11
                setpixel(the_fb.fb, xx, yy, the_fb.pitch, clr);
   82e18:	d2800001 	mov	x1, #0x0                   	// #0
   82e1c:	aa0a03e8 	mov	x8, x10
    int y = 0, x = 0;
   82e20:	52800002 	mov	w2, #0x0                   	// #0
    R(5, 8, cB, sB);
   82e24:	1b007d6b 	mul	w11, w11, w0
    int y = 0, x = 0;
   82e28:	52800003 	mov	w3, #0x0                   	// #0
    R(5, 7, cA, sA);
   82e2c:	1b097fde 	mul	w30, w30, w9
                setpixel(the_fb.fb, xx, yy, the_fb.pitch, clr);
   82e30:	72b99985 	movk	w5, #0xcccc, lsl #16
    R(5, 7, cA, sA);
   82e34:	1b097e73 	mul	w19, w19, w9
        if (k % 80) {
   82e38:	72a06664 	movk	w4, #0x333, lsl #16
    R(5, 8, cB, sB);
   82e3c:	1b007dce 	mul	w14, w14, w0
   82e40:	130a7d60 	asr	w0, w11, #10
    R(5, 7, cA, sA);
   82e44:	f000000b 	adrp	x11, 85000 <get_el+0x61c>
   82e48:	130a7fc9 	asr	w9, w30, #10
                setpixel(the_fb.fb, xx, yy, the_fb.pitch, clr);
   82e4c:	f940014a 	ldr	x10, [x10]
    R(5, 7, cA, sA);
   82e50:	130a7e66 	asr	w6, w19, #10
   82e54:	b90f2569 	str	w9, [x11, #3876]
    R(5, 8, cB, sB);
   82e58:	130a7dc9 	asr	w9, w14, #10
   82e5c:	b90005a9 	str	w9, [x13, #4]
    R(5, 7, cA, sA);
   82e60:	b90dc186 	str	w6, [x12, #3520]
    R(5, 8, cB, sB);
   82e64:	b90dc580 	str	w0, [x12, #3524]
                setpixel(the_fb.fb, xx, yy, the_fb.pitch, clr);
   82e68:	1b057c20 	mul	w0, w1, w5
   82e6c:	13801000 	ror	w0, w0, #4
        if (k % 80) {
   82e70:	6b04001f 	cmp	w0, w4
   82e74:	54000589 	b.ls	82f24 <draw_frame+0x364>  // b.plast
            if (x < 50) {
   82e78:	7100c45f 	cmp	w2, #0x31
   82e7c:	540001ad 	b.le	82eb0 <draw_frame+0x2f0>
            ...
            x++;
   82e80:	11000442 	add	w2, w2, #0x1
    for (int k = 0; 1761 > k; k++) {
   82e84:	91000421 	add	x1, x1, #0x1
   82e88:	f11b843f 	cmp	x1, #0x6e1
   82e8c:	54fffee1 	b.ne	82e68 <draw_frame+0x2a8>  // b.any
            x = 1;
        }
    }
   ...
   82e90:	52800020 	mov	w0, #0x1                   	// #1
   82e94:	a94153f3 	ldp	x19, x20, [sp, #16]
   82e98:	a9425bf5 	ldp	x21, x22, [sp, #32]
   82e9c:	a94363f7 	ldp	x23, x24, [sp, #48]
   82ea0:	a9446bf9 	ldp	x25, x26, [sp, #64]
   82ea4:	a94573fb 	ldp	x27, x28, [sp, #80]
   82ea8:	a8c77bfd 	ldp	x29, x30, [sp], #112
   82eac:	d65f03c0 	ret
                int K=6, xx=x*K, yy=y*K*2;
   82eb0:	531f7849 	lsl	w9, w2, #1
                PIXEL clr = int2rgb(b[k]); // to a color spectrum
   82eb4:	38676820 	ldrb	w0, [x1, x7]
                int K=6, xx=x*K, yy=y*K*2;
   82eb8:	0b03046b 	add	w11, w3, w3, lsl #1
   82ebc:	0b020126 	add	w6, w9, w2
...
static PIXEL int2rgb (int value) {
    int r,g,b;     
    if (value >= 0 && value <= 85) {
   82ec0:	7101541f 	cmp	w0, #0x55
                int K=6, xx=x*K, yy=y*K*2;
   82ec4:	531e756b 	lsl	w11, w11, #2
   82ec8:	531f78c6 	lsl	w6, w6, #1
    if (value >= 0 && value <= 85) {
   82ecc:	54000328 	b.hi	82f30 <draw_frame+0x370>  // b.pmore
        // Black to Yellow (R stays 0, G increases, B stays 0)
        r = 0;
        g = (value * 3);
   82ed0:	0b000400 	add	w0, w0, w0, lsl #1
   82ed4:	53185c00 	lsl	w0, w0, #8
    *(PIXEL *)(buf + y * pit + x * PIXELSIZE) = p;
   82ed8:	b940190c 	ldr	w12, [x8, #24]
   82edc:	0b020129 	add	w9, w9, w2
                setpixel(the_fb.fb, xx+1, yy, the_fb.pitch, clr);
   82ee0:	110004c6 	add	w6, w6, #0x1
    *(PIXEL *)(buf + y * pit + x * PIXELSIZE) = p;
   82ee4:	531d7129 	lsl	w9, w9, #3
   82ee8:	531e74c6 	lsl	w6, w6, #2
   82eec:	1b0c7d6c 	mul	w12, w11, w12
   82ef0:	8b29c149 	add	x9, x10, w9, sxtw
   82ef4:	8b26c146 	add	x6, x10, w6, sxtw
   82ef8:	b82cc920 	str	w0, [x9, w12, sxtw]
   82efc:	b940190c 	ldr	w12, [x8, #24]
   82f00:	1b0c7d6c 	mul	w12, w11, w12
   82f04:	b82cc8c0 	str	w0, [x6, w12, sxtw]
   82f08:	b940190c 	ldr	w12, [x8, #24]
   82f0c:	1b0c316c 	madd	w12, w11, w12, w12
   82f10:	b82cc920 	str	w0, [x9, w12, sxtw]
   82f14:	b9401909 	ldr	w9, [x8, #24]
   82f18:	1b092569 	madd	w9, w11, w9, w9
   82f1c:	b829c8c0 	str	w0, [x6, w9, sxtw]
}
   82f20:	17ffffd8 	b	82e80 <draw_frame+0x2c0>
            y++;
   82f24:	11000463 	add	w3, w3, #0x1
            x = 1;
   82f28:	52800022 	mov	w2, #0x1                   	// #1
   82f2c:	17ffffd6 	b	82e84 <draw_frame+0x2c4>
        b = 0;
    } else if (value > 85 && value <= 170) {
   82f30:	5101580c 	sub	w12, w0, #0x56
   82f34:	7101519f 	cmp	w12, #0x54
   82f38:	54000108 	b.hi	82f58 <draw_frame+0x398>  // b.pmore
        // Yellow to Cyan (G stays 255, R decreases, B increases)
        r = 255 - ((value - 85) * 3);
   82f3c:	51015400 	sub	w0, w0, #0x55
   82f40:	4b00080c 	sub	w12, w0, w0, lsl #2
        g = 255;
        b = (value - 85) * 3;
   82f44:	0b000400 	add	w0, w0, w0, lsl #1
        r = 255 - ((value - 85) * 3);
   82f48:	1103fd8c 	add	w12, w12, #0xff
   82f4c:	2a0c4000 	orr	w0, w0, w12, lsl #16
   82f50:	32181c00 	orr	w0, w0, #0xff00
   82f54:	17ffffe1 	b	82ed8 <draw_frame+0x318>
    } else if (value > 170 && value <= 255) {
        // Cyan to Blue (G decreases, B stays 255, R stays 0)
        r = 0;
        g = 255 - ((value - 170) * 3);
   82f58:	5102a800 	sub	w0, w0, #0xaa
   82f5c:	4b000800 	sub	w0, w0, w0, lsl #2
   82f60:	1103fc00 	add	w0, w0, #0xff
   82f64:	53185c00 	lsl	w0, w0, #8
   82f68:	32001c00 	orr	w0, w0, #0xff
   82f6c:	17ffffdb 	b	82ed8 <draw_frame+0x318>

0000000000082f70 <donut>:
void donut(void) {
   82f70:	a9bf7bfd 	stp	x29, x30, [sp, #-16]!
   82f74:	910003fd 	mov	x29, sp
    canvas_init();
   82f78:	97fffefe 	bl	82b70 <canvas_init>
    ret = ktimer_start(100, /*firing interval, ms*/
   82f7c:	90000001 	adrp	x1, 82000 <us_delay+0x10>
   82f80:	d2800003 	mov	x3, #0x0                   	// #0
   82f84:	912f0021 	add	x1, x1, #0xbc0
   82f88:	d2800002 	mov	x2, #0x0                   	// #0
   82f8c:	52800c80 	mov	w0, #0x64                  	// #100
   82f90:	97fffc5a 	bl	820f8 <ktimer_start>
    BUG_ON(ret<0);     
   82f94:	37f80060 	tbnz	w0, #31, 82fa0 <donut+0x30>
}
   82f98:	a8c17bfd 	ldp	x29, x30, [sp], #16
   82f9c:	d65f03c0 	ret
   82fa0:	a8c17bfd 	ldp	x29, x30, [sp], #16
    BUG_ON(ret<0);     
   82fa4:	f0000001 	adrp	x1, 85000 <get_el+0x61c>
   82fa8:	f0000000 	adrp	x0, 85000 <get_el+0x61c>
   82fac:	91058021 	add	x1, x1, #0x160
   82fb0:	9105a000 	add	x0, x0, #0x168
   82fb4:	52801022 	mov	w2, #0x81                  	// #129
   82fb8:	17fffa4a 	b	818e0 <assertion_failed>
   82fbc:	d503201f 	nop

0000000000082fc0 <donut_simple>:
void donut_simple(void) {
   82fc0:	a9bf7bfd 	stp	x29, x30, [sp, #-16]!
   82fc4:	910003fd 	mov	x29, sp
    canvas_init();
   82fc8:	97fffeea 	bl	82b70 <canvas_init>
    put32(TIMER_C1, 100 * 1000);	// in us
   82fcc:	d2860200 	mov	x0, #0x3010                	// #12304
   82fd0:	5290d401 	mov	w1, #0x86a0                	// #34464
   82fd4:	f2a7e000 	movk	x0, #0x3f00, lsl #16
   82fd8:	72a00021 	movk	w1, #0x1, lsl #16
   82fdc:	b9000001 	str	w1, [x0]
}
   82fe0:	a8c17bfd 	ldp	x29, x30, [sp], #16
   82fe4:	d65f03c0 	ret

0000000000082fe8 <sys_timer_irq_simple>:
    BUG_ON(!(get32(TIMER_CS) & TIMER_CS_M1));  
   82fe8:	d2860000 	mov	x0, #0x3000                	// #12288
{
   82fec:	a9bf7bfd 	stp	x29, x30, [sp, #-16]!
    BUG_ON(!(get32(TIMER_CS) & TIMER_CS_M1));  
   82ff0:	f2a7e000 	movk	x0, #0x3f00, lsl #16
{
   82ff4:	910003fd 	mov	x29, sp
    BUG_ON(!(get32(TIMER_CS) & TIMER_CS_M1));  
   82ff8:	b9400000 	ldr	w0, [x0]
   82ffc:	36080160 	tbz	w0, #1, 83028 <sys_timer_irq_simple+0x40>
	put32(TIMER_CS, TIMER_CS_M1);	// clear timer1 match
   83000:	d2860000 	mov	x0, #0x3000                	// #12288
   83004:	52800043 	mov	w3, #0x2                   	// #2
   83008:	f2a7e000 	movk	x0, #0x3f00, lsl #16
    draw_frame(0, 0, 0); 
   8300c:	d2800002 	mov	x2, #0x0                   	// #0
   83010:	d2800001 	mov	x1, #0x0                   	// #0
	put32(TIMER_CS, TIMER_CS_M1);	// clear timer1 match
   83014:	b9000003 	str	w3, [x0]
    draw_frame(0, 0, 0); 
   83018:	d2800000 	mov	x0, #0x0                   	// #0
   8301c:	97fffee9 	bl	82bc0 <draw_frame>
}
   83020:	a8c17bfd 	ldp	x29, x30, [sp], #16
    cur = current_counter(); 
   83024:	17fffbd9 	b	81f88 <current_counter>
    BUG_ON(!(get32(TIMER_CS) & TIMER_CS_M1));  
   83028:	d0000001 	adrp	x1, 85000 <get_el+0x61c>
   8302c:	b0000000 	adrp	x0, 84000 <vectors>
   83030:	91058021 	add	x1, x1, #0x160
   83034:	913aa000 	add	x0, x0, #0xea8
   83038:	52801302 	mov	w2, #0x98                  	// #152
   8303c:	97fffa29 	bl	818e0 <assertion_failed>
   83040:	17fffff0 	b	83000 <sys_timer_irq_simple+0x18>
   83044:	d503201f 	nop

0000000000083048 <donut_text>:
void donut_text(void) {
   83048:	a9ba7bfd 	stp	x29, x30, [sp, #-96]!
   8304c:	910003fd 	mov	x29, sp
   83050:	a9046bf9 	stp	x25, x26, [sp, #64]
   83054:	f0000019 	adrp	x25, 86000 <_binary_font_psf_start+0xac>
        memset(b, 32, 1760);  // text buffer
   83058:	912f8339 	add	x25, x25, #0xbe0
void donut_text(void) {
   8305c:	a9025bf5 	stp	x21, x22, [sp, #32]
    int sA = 1024, cA = 0, sB = 1024, cB = 0, _;
   83060:	52808015 	mov	w21, #0x400                 	// #1024
   83064:	52800016 	mov	w22, #0x0                   	// #0
void donut_text(void) {
   83068:	a90363f7 	stp	x23, x24, [sp, #48]
        memset(z, 127, 1760); // z buffer
   8306c:	911b8338 	add	x24, x25, #0x6e0
    int sA = 1024, cA = 0, sB = 1024, cB = 0, _;
   83070:	2a1503f7 	mov	w23, w21
void donut_text(void) {
   83074:	a90153f3 	stp	x19, x20, [sp, #16]
    int sA = 1024, cA = 0, sB = 1024, cB = 0, _;
   83078:	52800014 	mov	w20, #0x0                   	// #0
   8307c:	d0000013 	adrp	x19, 85000 <get_el+0x61c>
void donut_text(void) {
   83080:	a90573fb 	stp	x27, x28, [sp, #80]
        memset(b, 32, 1760);  // text buffer
   83084:	5280dc02 	mov	w2, #0x6e0                 	// #1760
   83088:	52800401 	mov	w1, #0x20                  	// #32
   8308c:	aa1903e0 	mov	x0, x25
   83090:	97fffa20 	bl	81910 <memset>
        memset(z, 127, 1760); // z buffer
   83094:	4b1603fc 	neg	w28, w22
   83098:	aa1803e0 	mov	x0, x24
   8309c:	5280dc02 	mov	w2, #0x6e0                 	// #1760
   830a0:	52800fe1 	mov	w1, #0x7f                  	// #127
   830a4:	4b1703fb 	neg	w27, w23
   830a8:	97fffa1a 	bl	81910 <memset>
                    b[o] = ".,-~:;=!*#$@"[N > 0 ? N : 0];
   830ac:	9106027a 	add	x26, x19, #0x180
        memset(z, 127, 1760); // z buffer
   830b0:	52800b5e 	mov	w30, #0x5a                  	// #90
        int sj = 0, cj = 1024;
   830b4:	52808012 	mov	w18, #0x400                 	// #1024
   830b8:	52800011 	mov	w17, #0x0                   	// #0
                R(5, 8, ci, si) // rotate i
   830bc:	52a0060e 	mov	w14, #0x300000              	// #3145728
                    x5 = sA * sj >> 10,
   830c0:	1b117eef 	mul	w15, w23, w17
   830c4:	1120024b 	add	w11, w18, #0x800
                    x2 = cA * sj >> 10,
   830c8:	1b117ecc 	mul	w12, w22, w17
                    N = (((-cA * x7 - cB * ((-sA * x7 >> 10) + x2) - ci * (cj * sB >> 10)) >> 10) - x5) >> 7;
   830cc:	5280288a 	mov	w10, #0x144                 	// #324
   830d0:	1b127eb0 	mul	w16, w21, w18
                    x6 = K2 + R1 * 1024 * x5 + cA * x3,
   830d4:	121655ed 	and	w13, w15, #0xfffffc00
   830d8:	115401ad 	add	w13, w13, #0x500, lsl #12
                    x5 = sA * sj >> 10,
   830dc:	130a7def 	asr	w15, w15, #10
                    x2 = cA * sj >> 10,
   830e0:	130a7d8c 	asr	w12, w12, #10
            int si = 0, ci = 1024; // sine and cosine of angle i
   830e4:	52808007 	mov	w7, #0x400                 	// #1024
                    N = (((-cA * x7 - cB * ((-sA * x7 >> 10) + x2) - ci * (cj * sB >> 10)) >> 10) - x5) >> 7;
   830e8:	130a7e10 	asr	w16, w16, #10
            int si = 0, ci = 1024; // sine and cosine of angle i
   830ec:	52800003 	mov	w3, #0x0                   	// #0
                    x3 = si * x0 >> 10,
   830f0:	1b0b7c69 	mul	w9, w3, w11
                R(5, 8, ci, si) // rotate i
   830f4:	0b030860 	add	w0, w3, w3, lsl #2
                    x1 = ci * x0 >> 10,
   830f8:	1b0b7ce2 	mul	w2, w7, w11
                R(5, 8, ci, si) // rotate i
   830fc:	0b0708e4 	add	w4, w7, w7, lsl #2
   83100:	4b8020e0 	sub	w0, w7, w0, asr #8
                    x3 = si * x0 >> 10,
   83104:	130a7d26 	asr	w6, w9, #10
                R(5, 8, ci, si) // rotate i
   83108:	0b842064 	add	w4, w3, w4, asr #8
                    x1 = ci * x0 >> 10,
   8310c:	130a7c42 	asr	w2, w2, #10
                R(5, 8, ci, si) // rotate i
   83110:	1b00b801 	msub	w1, w0, w0, w14
                    x4 = R1 * x2 - (sA * x3 >> 10),
   83114:	1b067ee5 	mul	w5, w23, w6
                    x = 25 + 30 * (cB * x1 - sB * x4) / x6,
   83118:	1b027e88 	mul	w8, w20, w2
                    y = 12 + 15 * (cB * x4 + sB * x1) / x6,
   8311c:	1b027ea2 	mul	w2, w21, w2
                    x4 = R1 * x2 - (sA * x3 >> 10),
   83120:	4b852985 	sub	w5, w12, w5, asr #10
                    x6 = K2 + R1 * 1024 * x5 + cA * x3,
   83124:	1b0636c6 	madd	w6, w22, w6, w13
                R(5, 8, ci, si) // rotate i
   83128:	1b048481 	msub	w1, w4, w4, w1
                    x = 25 + 30 * (cB * x1 - sB * x4) / x6,
   8312c:	1b05a2a8 	msub	w8, w21, w5, w8
                    y = 12 + 15 * (cB * x4 + sB * x1) / x6,
   83130:	1b050a82 	madd	w2, w20, w5, w2
                R(5, 8, ci, si) // rotate i
   83134:	130b7c21 	asr	w1, w1, #11
                    x = 25 + 30 * (cB * x1 - sB * x4) / x6,
   83138:	531c6d05 	lsl	w5, w8, #4
   8313c:	4b0800a8 	sub	w8, w5, w8
                    y = 12 + 15 * (cB * x4 + sB * x1) / x6,
   83140:	531c6c45 	lsl	w5, w2, #4
   83144:	4b0200a2 	sub	w2, w5, w2
                R(5, 8, ci, si) // rotate i
   83148:	1b017c00 	mul	w0, w0, w1
   8314c:	1b017c81 	mul	w1, w4, w1
                    x = 25 + 30 * (cB * x1 - sB * x4) / x6,
   83150:	531f7908 	lsl	w8, w8, #1
                    y = 12 + 15 * (cB * x4 + sB * x1) / x6,
   83154:	1ac60c42 	sdiv	w2, w2, w6
                if (22 > y && y > 0 && x > 0 && 80 > x && zz < z[o]) {
   83158:	11002c44 	add	w4, w2, #0xb
   8315c:	7100509f 	cmp	w4, #0x14
   83160:	540003c8 	b.hi	831d8 <donut_text+0x190>  // b.pmore
                    x = 25 + 30 * (cB * x1 - sB * x4) / x6,
   83164:	1ac60d08 	sdiv	w8, w8, w6
                    y = 12 + 15 * (cB * x4 + sB * x1) / x6,
   83168:	11003042 	add	w2, w2, #0xc
                signed char zz = (x6 - K2) >> 15;
   8316c:	515400c4 	sub	w4, w6, #0x500, lsl #12
                int o = x + 80 * y; // fxl: 80 chars per row
   83170:	0b020842 	add	w2, w2, w2, lsl #2
                signed char zz = (x6 - K2) >> 15;
   83174:	934f5884 	sbfx	x4, x4, #15, #8
                    x = 25 + 30 * (cB * x1 - sB * x4) / x6,
   83178:	11006505 	add	w5, w8, #0x19
                if (22 > y && y > 0 && x > 0 && 80 > x && zz < z[o]) {
   8317c:	11006108 	add	w8, w8, #0x18
                int o = x + 80 * y; // fxl: 80 chars per row
   83180:	0b0210a2 	add	w2, w5, w2, lsl #4
                if (22 > y && y > 0 && x > 0 && 80 > x && zz < z[o]) {
   83184:	7101391f 	cmp	w8, #0x4e
   83188:	54000288 	b.hi	831d8 <donut_text+0x190>  // b.pmore
   8318c:	38e2cb05 	ldrsb	w5, [x24, w2, sxtw]
                    x7 = cj * si >> 10,
   83190:	4b032d23 	sub	w3, w9, w3, lsl #11
                if (22 > y && y > 0 && x > 0 && 80 > x && zz < z[o]) {
   83194:	6b0400bf 	cmp	w5, w4
                    x7 = cj * si >> 10,
   83198:	130a7c63 	asr	w3, w3, #10
                if (22 > y && y > 0 && x > 0 && 80 > x && zz < z[o]) {
   8319c:	540001ed 	b.le	831d8 <donut_text+0x190>
                    N = (((-cA * x7 - cB * ((-sA * x7 >> 10) + x2) - ci * (cj * sB >> 10)) >> 10) - x5) >> 7;
   831a0:	1b1b7c65 	mul	w5, w3, w27
                    z[o] = zz;
   831a4:	3822cb04 	strb	w4, [x24, w2, sxtw]
                    N = (((-cA * x7 - cB * ((-sA * x7 >> 10) + x2) - ci * (cj * sB >> 10)) >> 10) - x5) >> 7;
   831a8:	1b1c7c63 	mul	w3, w3, w28
   831ac:	0b852984 	add	w4, w12, w5, asr #10
   831b0:	1b148c83 	msub	w3, w4, w20, w3
   831b4:	1b078e03 	msub	w3, w16, w7, w3
   831b8:	130a7c63 	asr	w3, w3, #10
   831bc:	4b0f0063 	sub	w3, w3, w15
   831c0:	13077c63 	asr	w3, w3, #7
                    b[o] = ".,-~:;=!*#$@"[N > 0 ? N : 0];
   831c4:	7100007f 	cmp	w3, #0x0
   831c8:	1a9fa063 	csel	w3, w3, wzr, ge  // ge = tcont
   831cc:	3863cb43 	ldrb	w3, [x26, w3, sxtw]
   831d0:	3822cb23 	strb	w3, [x25, w2, sxtw]
   831d4:	d503201f 	nop
                R(5, 8, ci, si) // rotate i
   831d8:	130a7c07 	asr	w7, w0, #10
   831dc:	130a7c23 	asr	w3, w1, #10
            for (int i = 0; i < 324; i++) {
   831e0:	7100054a 	subs	w10, w10, #0x1
   831e4:	54fff861 	b.ne	830f0 <donut_text+0xa8>  // b.any
            R(9, 7, cj, sj) // rotate j
   831e8:	0b110e21 	add	w1, w17, w17, lsl #3
   831ec:	0b120e40 	add	w0, w18, w18, lsl #3
        for (int j = 0; j < 90; j++) {
   831f0:	710007de 	subs	w30, w30, #0x1
            R(9, 7, cj, sj) // rotate j
   831f4:	4b811e52 	sub	w18, w18, w1, asr #7
   831f8:	0b801e31 	add	w17, w17, w0, asr #7
   831fc:	1b12ba40 	msub	w0, w18, w18, w14
   83200:	1b118220 	msub	w0, w17, w17, w0
   83204:	130b7c00 	asr	w0, w0, #11
   83208:	1b007e52 	mul	w18, w18, w0
   8320c:	1b007e31 	mul	w17, w17, w0
   83210:	130a7e52 	asr	w18, w18, #10
   83214:	130a7e31 	asr	w17, w17, #10
        for (int j = 0; j < 90; j++) {
   83218:	54fff541 	b.ne	830c0 <donut_text+0x78>  // b.any
        R(5, 7, cA, sA);
   8321c:	0b170ae3 	add	w3, w23, w23, lsl #2
        R(5, 8, cB, sB);
   83220:	0b150aa1 	add	w1, w21, w21, lsl #2
        R(5, 7, cA, sA);
   83224:	0b160ac2 	add	w2, w22, w22, lsl #2
        R(5, 8, cB, sB);
   83228:	0b140a80 	add	w0, w20, w20, lsl #2
        R(5, 7, cA, sA);
   8322c:	4b831ed6 	sub	w22, w22, w3, asr #7
        R(5, 8, cB, sB);
   83230:	4b812294 	sub	w20, w20, w1, asr #8
        R(5, 7, cA, sA);
   83234:	0b821ef7 	add	w23, w23, w2, asr #7
        R(5, 8, cB, sB);
   83238:	0b8022b5 	add	w21, w21, w0, asr #8
   8323c:	529999ba 	mov	w26, #0xcccd                	// #52429
   83240:	d280003c 	mov	x28, #0x1                   	// #1
        R(5, 7, cA, sA);
   83244:	1b16bac2 	msub	w2, w22, w22, w14
        R(5, 8, cB, sB);
   83248:	72b9999a 	movk	w26, #0xcccc, lsl #16
   8324c:	1b14ba80 	msub	w0, w20, w20, w14
            putc(0, k % 80 ? b[k] : 10);
   83250:	52800141 	mov	w1, #0xa                   	// #10
        R(5, 7, cA, sA);
   83254:	1b178ae2 	msub	w2, w23, w23, w2
            putc(0, k % 80 ? b[k] : 10);
   83258:	5286667b 	mov	w27, #0x3333                	// #13107
        R(5, 8, cB, sB);
   8325c:	1b1582a0 	msub	w0, w21, w21, w0
            putc(0, k % 80 ? b[k] : 10);
   83260:	72a0667b 	movk	w27, #0x333, lsl #16
        R(5, 7, cA, sA);
   83264:	130b7c42 	asr	w2, w2, #11
        R(5, 8, cB, sB);
   83268:	130b7c00 	asr	w0, w0, #11
        R(5, 7, cA, sA);
   8326c:	1b027ed6 	mul	w22, w22, w2
   83270:	1b027ef7 	mul	w23, w23, w2
        R(5, 8, cB, sB);
   83274:	1b007e94 	mul	w20, w20, w0
   83278:	1b007eb5 	mul	w21, w21, w0
            putc(0, k % 80 ? b[k] : 10);
   8327c:	d2800000 	mov	x0, #0x0                   	// #0
   83280:	940001b8 	bl	83960 <putc>
        R(5, 7, cA, sA);
   83284:	130a7ed6 	asr	w22, w22, #10
        R(5, 8, cB, sB);
   83288:	1b1c7f40 	mul	w0, w26, w28
        R(5, 7, cA, sA);
   8328c:	130a7ef7 	asr	w23, w23, #10
        R(5, 8, cB, sB);
   83290:	130a7e94 	asr	w20, w20, #10
   83294:	130a7eb5 	asr	w21, w21, #10
        for (int k = 0; 1761 > k; k++)
   83298:	f11b879f 	cmp	x28, #0x6e1
   8329c:	54000180 	b.eq	832cc <donut_text+0x284>  // b.none
            putc(0, k % 80 ? b[k] : 10);
   832a0:	52800141 	mov	w1, #0xa                   	// #10
        R(5, 8, cB, sB);
   832a4:	13801000 	ror	w0, w0, #4
            putc(0, k % 80 ? b[k] : 10);
   832a8:	6b1b001f 	cmp	w0, w27
   832ac:	54000049 	b.ls	832b4 <donut_text+0x26c>  // b.plast
   832b0:	38796b81 	ldrb	w1, [x28, x25]
   832b4:	9100079c 	add	x28, x28, #0x1
   832b8:	d2800000 	mov	x0, #0x0                   	// #0
   832bc:	940001a9 	bl	83960 <putc>
        for (int k = 0; 1761 > k; k++)
   832c0:	f11b879f 	cmp	x28, #0x6e1
        R(5, 8, cB, sB);
   832c4:	1b1c7f40 	mul	w0, w26, w28
        for (int k = 0; 1761 > k; k++)
   832c8:	54fffec1 	b.ne	832a0 <donut_text+0x258>  // b.any
        printf("\x1b[23A");  // clear console 
   832cc:	d0000000 	adrp	x0, 85000 <get_el+0x61c>
   832d0:	9105e000 	add	x0, x0, #0x178
   832d4:	97fff8b5 	bl	815a8 <tfp_printf>
        ms_delay(10);  // can delay in this way, but inefficient
   832d8:	52800140 	mov	w0, #0xa                   	// #10
   832dc:	97fffb35 	bl	81fb0 <ms_delay>
    while (1) {
   832e0:	17ffff69 	b	83084 <donut_text+0x3c>
   832e4:	00000000 	udf	#0

00000000000832e8 <handler>:
...
static int handler(TKernelTimerHandle hTimer, void *param, void *context) {
   832e8:	d10183ff 	sub	sp, sp, #0x60
   832ec:	a9017bfd 	stp	x29, x30, [sp, #16]
   832f0:	910043fd 	add	x29, sp, #0x10
   832f4:	a90253f3 	stp	x19, x20, [sp, #32]
   832f8:	aa0003f3 	mov	x19, x0
   832fc:	aa0103f4 	mov	x20, x1
	unsigned sec, msec; 
	current_time(&sec, &msec);
   83300:	910163e0 	add	x0, sp, #0x58
   83304:	910173e1 	add	x1, sp, #0x5c
static int handler(TKernelTimerHandle hTimer, void *param, void *context) {
   83308:	a9035bf5 	stp	x21, x22, [sp, #48]
   8330c:	aa0203f5 	mov	x21, x2
   83310:	f90023f7 	str	x23, [sp, #64]
	current_time(&sec, &msec);
   83314:	97fffb45 	bl	82028 <current_time>
	I("%u.%03u: fired. on cpu %d. htimer %ld, param %lx, contex %lx", sec, msec,
   83318:	294b5ff6 	ldp	w22, w23, [sp, #88]
   8331c:	940005a6 	bl	849b4 <cpuid>
   83320:	f90003f5 	str	x21, [sp]
   83324:	aa1403e7 	mov	x7, x20
   83328:	aa1303e6 	mov	x6, x19
   8332c:	2a1703e4 	mov	w4, w23
   83330:	2a1603e3 	mov	w3, w22
   83334:	2a0003e5 	mov	w5, w0
   83338:	52800182 	mov	w2, #0xc                   	// #12
   8333c:	d0000001 	adrp	x1, 85000 <get_el+0x61c>
   83340:	d0000000 	adrp	x0, 85000 <get_el+0x61c>
   83344:	91064021 	add	x1, x1, #0x190
   83348:	91068000 	add	x0, x0, #0x1a0
   8334c:	97fff897 	bl	815a8 <tfp_printf>
		cpuid(), hTimer, (unsigned long)param, (unsigned long)context); 
    return 0; // don't restart the timer
}
   83350:	52800000 	mov	w0, #0x0                   	// #0
   83354:	a9417bfd 	ldp	x29, x30, [sp, #16]
   83358:	a94253f3 	ldp	x19, x20, [sp, #32]
   8335c:	a9435bf5 	ldp	x21, x22, [sp, #48]
   83360:	f94023f7 	ldr	x23, [sp, #64]
   83364:	910183ff 	add	sp, sp, #0x60
   83368:	d65f03c0 	ret
   8336c:	d503201f 	nop

0000000000083370 <test_ktimer2_handler>:
...
static int test_ktimer2_handler(TKernelTimerHandle hTimer, void *param, 
    void *context) {
   83370:	a9bc7bfd 	stp	x29, x30, [sp, #-64]!
   83374:	910003fd 	mov	x29, sp
   83378:	a90153f3 	stp	x19, x20, [sp, #16]
   8337c:	aa0003f4 	mov	x20, x0
   83380:	aa0103f3 	mov	x19, x1
	unsigned sec, msec; 
	current_time(&sec, &msec);
   83384:	9100e3e0 	add	x0, sp, #0x38
   83388:	9100f3e1 	add	x1, sp, #0x3c
    void *context) {
   8338c:	a9025bf5 	stp	x21, x22, [sp, #32]
	current_time(&sec, &msec);
   83390:	97fffb26 	bl	82028 <current_time>
	printf("%s %u.%03u: fired. on cpu %d. htimer %ld\n" _k2clr_none, 
   83394:	29475bf5 	ldp	w21, w22, [sp, #56]
   83398:	94000587 	bl	849b4 <cpuid>
   8339c:	aa1403e5 	mov	x5, x20
   833a0:	aa1303e1 	mov	x1, x19
   833a4:	2a1603e3 	mov	w3, w22
   833a8:	2a1503e2 	mov	w2, w21
   833ac:	2a0003e4 	mov	w4, w0
   833b0:	d0000000 	adrp	x0, 85000 <get_el+0x61c>
   833b4:	9107c000 	add	x0, x0, #0x1f0
   833b8:	97fff87c 	bl	815a8 <tfp_printf>
        (char *)param, sec, msec, cpuid(), hTimer); 
    return 1; // restart the timer 
}
   833bc:	52800020 	mov	w0, #0x1                   	// #1
   833c0:	a94153f3 	ldp	x19, x20, [sp, #16]
   833c4:	a9425bf5 	ldp	x21, x22, [sp, #32]
   833c8:	a8c47bfd 	ldp	x29, x30, [sp], #64
   833cc:	d65f03c0 	ret

00000000000833d0 <test_ktimer>:
void test_ktimer() {
   833d0:	a9bb7bfd 	stp	x29, x30, [sp, #-80]!
   833d4:	910003fd 	mov	x29, sp
   833d8:	a90153f3 	stp	x19, x20, [sp, #16]
	current_time(&sec, &msec); 
   833dc:	910123f4 	add	x20, sp, #0x48
   833e0:	aa1403e0 	mov	x0, x20
void test_ktimer() {
   833e4:	a9025bf5 	stp	x21, x22, [sp, #32]
	current_time(&sec, &msec); 
   833e8:	910133f5 	add	x21, sp, #0x4c
   833ec:	aa1503e1 	mov	x1, x21
void test_ktimer() {
   833f0:	f9001bf7 	str	x23, [sp, #48]
	current_time(&sec, &msec); 
   833f4:	97fffb0d 	bl	82028 <current_time>
	I("%u.%03u start delaying 500ms...", sec, msec); 
   833f8:	294913e3 	ldp	w3, w4, [sp, #72]
   833fc:	d0000017 	adrp	x23, 85000 <get_el+0x61c>
   83400:	910642f3 	add	x19, x23, #0x190
   83404:	528002c2 	mov	w2, #0x16                  	// #22
   83408:	aa1303e1 	mov	x1, x19
   8340c:	d0000000 	adrp	x0, 85000 <get_el+0x61c>
   83410:	91088000 	add	x0, x0, #0x220
   83414:	97fff865 	bl	815a8 <tfp_printf>
	ms_delay(500); 
   83418:	52803e80 	mov	w0, #0x1f4                 	// #500
   8341c:	97fffae5 	bl	81fb0 <ms_delay>
	current_time(&sec, &msec);
   83420:	aa1503e1 	mov	x1, x21
   83424:	aa1403e0 	mov	x0, x20
   83428:	97fffb00 	bl	82028 <current_time>
	int t = ktimer_start(500, handler, (void *)0xdeadbeef, (void*)0xdeaddeed);
   8342c:	90000015 	adrp	x21, 83000 <sys_timer_irq_simple+0x18>
	I("%u.%03u ended delaying 500ms", sec, msec); 
   83430:	294913e3 	ldp	w3, w4, [sp, #72]
   83434:	aa1303e1 	mov	x1, x19
   83438:	52800322 	mov	w2, #0x19                  	// #25
   8343c:	d0000000 	adrp	x0, 85000 <get_el+0x61c>
   83440:	91096000 	add	x0, x0, #0x258
	int t = ktimer_start(500, handler, (void *)0xdeadbeef, (void*)0xdeaddeed);
   83444:	910ba2b5 	add	x21, x21, #0x2e8
	I("%u.%03u ended delaying 500ms", sec, msec); 
   83448:	97fff858 	bl	815a8 <tfp_printf>
	I("timer start. timer id %u", t); 
   8344c:	d0000014 	adrp	x20, 85000 <get_el+0x61c>
	int t = ktimer_start(500, handler, (void *)0xdeadbeef, (void*)0xdeaddeed);
   83450:	d29bdda3 	mov	x3, #0xdeed                	// #57069
   83454:	d297dde2 	mov	x2, #0xbeef                	// #48879
   83458:	aa1503e1 	mov	x1, x21
   8345c:	f2bbd5a3 	movk	x3, #0xdead, lsl #16
   83460:	f2bbd5a2 	movk	x2, #0xdead, lsl #16
   83464:	52803e80 	mov	w0, #0x1f4                 	// #500
   83468:	97fffb24 	bl	820f8 <ktimer_start>
	I("timer start. timer id %u", t); 
   8346c:	2a0003e3 	mov	w3, w0
   83470:	aa1303e1 	mov	x1, x19
   83474:	910a2294 	add	x20, x20, #0x288
   83478:	528003a2 	mov	w2, #0x1d                  	// #29
	int t = ktimer_start(500, handler, (void *)0xdeadbeef, (void*)0xdeaddeed);
   8347c:	2a0003f6 	mov	w22, w0
	I("timer start. timer id %u", t); 
   83480:	aa1403e0 	mov	x0, x20
   83484:	97fff849 	bl	815a8 <tfp_printf>
	ms_delay(1000);
   83488:	52807d00 	mov	w0, #0x3e8                 	// #1000
   8348c:	97fffac9 	bl	81fb0 <ms_delay>
	I("timer %d should have fired", t); 
   83490:	2a1603e3 	mov	w3, w22
   83494:	aa1303e1 	mov	x1, x19
   83498:	528003e2 	mov	w2, #0x1f                  	// #31
   8349c:	d0000000 	adrp	x0, 85000 <get_el+0x61c>
   834a0:	910ae000 	add	x0, x0, #0x2b8
   834a4:	97fff841 	bl	815a8 <tfp_printf>
	t = ktimer_start(500, handler, (void *)0xdeadbeef, (void*)0xdeaddeed);
   834a8:	d29bdda3 	mov	x3, #0xdeed                	// #57069
   834ac:	d297dde2 	mov	x2, #0xbeef                	// #48879
   834b0:	aa1503e1 	mov	x1, x21
   834b4:	f2bbd5a3 	movk	x3, #0xdead, lsl #16
   834b8:	f2bbd5a2 	movk	x2, #0xdead, lsl #16
   834bc:	52803e80 	mov	w0, #0x1f4                 	// #500
   834c0:	97fffb0e 	bl	820f8 <ktimer_start>
	I("timer start. timer id %u", t); 
   834c4:	2a0003e3 	mov	w3, w0
   834c8:	aa1303e1 	mov	x1, x19
   834cc:	aa1403e0 	mov	x0, x20
   834d0:	52800462 	mov	w2, #0x23                  	// #35
   834d4:	97fff835 	bl	815a8 <tfp_printf>
	t = ktimer_start(1000, handler, (void *)0xdeadbeef, (void*)0xdeaddeed);
   834d8:	d29bdda3 	mov	x3, #0xdeed                	// #57069
   834dc:	d297dde2 	mov	x2, #0xbeef                	// #48879
   834e0:	aa1503e1 	mov	x1, x21
   834e4:	f2bbd5a3 	movk	x3, #0xdead, lsl #16
   834e8:	f2bbd5a2 	movk	x2, #0xdead, lsl #16
   834ec:	52807d00 	mov	w0, #0x3e8                 	// #1000
   834f0:	97fffb02 	bl	820f8 <ktimer_start>
	I("timer start. timer id %u", t); 
   834f4:	2a0003e3 	mov	w3, w0
   834f8:	aa1303e1 	mov	x1, x19
   834fc:	528004a2 	mov	w2, #0x25                  	// #37
   83500:	aa1403e0 	mov	x0, x20
   83504:	97fff829 	bl	815a8 <tfp_printf>
	ms_delay(2000); 
   83508:	5280fa00 	mov	w0, #0x7d0                 	// #2000
   8350c:	97fffaa9 	bl	81fb0 <ms_delay>
	I("both timers should have fired"); 
   83510:	aa1303e1 	mov	x1, x19
   83514:	528004e2 	mov	w2, #0x27                  	// #39
   83518:	d0000000 	adrp	x0, 85000 <get_el+0x61c>
   8351c:	910ba000 	add	x0, x0, #0x2e8
   83520:	97fff822 	bl	815a8 <tfp_printf>
	t = ktimer_start(500, handler, (void *)0xdeadbeef, (void*)0xdeaddeed);
   83524:	d29bdda3 	mov	x3, #0xdeed                	// #57069
   83528:	d297dde2 	mov	x2, #0xbeef                	// #48879
   8352c:	aa1503e1 	mov	x1, x21
   83530:	f2bbd5a3 	movk	x3, #0xdead, lsl #16
   83534:	f2bbd5a2 	movk	x2, #0xdead, lsl #16
   83538:	52803e80 	mov	w0, #0x1f4                 	// #500
   8353c:	97fffaef 	bl	820f8 <ktimer_start>
	I("timer start. timer id %u", t);
   83540:	2a0003e3 	mov	w3, w0
   83544:	aa1303e1 	mov	x1, x19
   83548:	52800562 	mov	w2, #0x2b                  	// #43
	t = ktimer_start(500, handler, (void *)0xdeadbeef, (void*)0xdeaddeed);
   8354c:	2a0003f5 	mov	w21, w0
	I("timer start. timer id %u", t);
   83550:	aa1403e0 	mov	x0, x20
   83554:	97fff815 	bl	815a8 <tfp_printf>
	ms_delay(100); 
   83558:	52800c80 	mov	w0, #0x64                  	// #100
   8355c:	97fffa95 	bl	81fb0 <ms_delay>
	int c = ktimer_cancel(t); 
   83560:	2a1503e0 	mov	w0, w21
   83564:	97fffb2d 	bl	82218 <ktimer_cancel>
	I("timer cancel return val = %d", c);
   83568:	aa1303e1 	mov	x1, x19
	int c = ktimer_cancel(t); 
   8356c:	2a0003f4 	mov	w20, w0
	I("timer cancel return val = %d", c);
   83570:	2a0003e3 	mov	w3, w0
   83574:	528005c2 	mov	w2, #0x2e                  	// #46
   83578:	d0000000 	adrp	x0, 85000 <get_el+0x61c>
   8357c:	910c8000 	add	x0, x0, #0x320
   83580:	97fff80a 	bl	815a8 <tfp_printf>
	BUG_ON(c < 0);
   83584:	37f80174 	tbnz	w20, #31, 835b0 <test_ktimer+0x1e0>
	I("there shouldn't be more callback"); 
   83588:	910642e1 	add	x1, x23, #0x190
   8358c:	52800622 	mov	w2, #0x31                  	// #49
   83590:	d0000000 	adrp	x0, 85000 <get_el+0x61c>
   83594:	910d8000 	add	x0, x0, #0x360
   83598:	97fff804 	bl	815a8 <tfp_printf>
}
   8359c:	a94153f3 	ldp	x19, x20, [sp, #16]
   835a0:	a9425bf5 	ldp	x21, x22, [sp, #32]
   835a4:	f9401bf7 	ldr	x23, [sp, #48]
   835a8:	a8c57bfd 	ldp	x29, x30, [sp], #80
   835ac:	d65f03c0 	ret
	BUG_ON(c < 0);
   835b0:	aa1303e1 	mov	x1, x19
   835b4:	d0000000 	adrp	x0, 85000 <get_el+0x61c>
   835b8:	528005e2 	mov	w2, #0x2f                  	// #47
   835bc:	910d4000 	add	x0, x0, #0x350
   835c0:	97fff8c8 	bl	818e0 <assertion_failed>
   835c4:	17fffff1 	b	83588 <test_ktimer+0x1b8>

00000000000835c8 <test_ktimer2>:
...
void test_ktimer2(int c) {
   835c8:	a9bc7bfd 	stp	x29, x30, [sp, #-64]!
   835cc:	910003fd 	mov	x29, sp
   835d0:	a90153f3 	stp	x19, x20, [sp, #16]
    if (c<'0' || c>'9') return; 
   835d4:	5100c014 	sub	w20, w0, #0x30
   835d8:	7100269f 	cmp	w20, #0x9
   835dc:	540002e8 	b.hi	83638 <test_ktimer2+0x70>  // b.pmore
   835e0:	a9025bf5 	stp	x21, x22, [sp, #32]
    int ret; 
    if (c=='0') {
   835e4:	7100c01f 	cmp	w0, #0x30
   835e8:	540002e0 	b.eq	83644 <test_ktimer2+0x7c>  // b.none
                timers[i]=-1;
        ...
        int idx = c-'1'; 
   835ec:	5100c400 	sub	w0, w0, #0x31
        if (timers[idx]!=-1) { // cancel the timer
   835f0:	d0000016 	adrp	x22, 85000 <get_el+0x61c>
   835f4:	913cc2d5 	add	x21, x22, #0xf30
   835f8:	93407c13 	sxtw	x19, w0
   835fc:	b8737aa0 	ldr	w0, [x21, x19, lsl #2]
   83600:	3100041f 	cmn	w0, #0x1
   83604:	540005c0 	b.eq	836bc <test_ktimer2+0xf4>  // b.none
            W("ktimer_cancel %d", idx+1); 
   83608:	2a1403e3 	mov	w3, w20
   8360c:	52800c62 	mov	w2, #0x63                  	// #99
   83610:	d0000001 	adrp	x1, 85000 <get_el+0x61c>
   83614:	d0000000 	adrp	x0, 85000 <get_el+0x61c>
   83618:	91064021 	add	x1, x1, #0x190
   8361c:	910f4000 	add	x0, x0, #0x3d0
   83620:	97fff7e2 	bl	815a8 <tfp_printf>
            ret = ktimer_cancel(timers[idx]); 
   83624:	b8737aa0 	ldr	w0, [x21, x19, lsl #2]
   83628:	97fffafc 	bl	82218 <ktimer_cancel>
            // BUG_ON(ret == -1); // no such timer (maybe benign? like just fired?
            timers[idx]=-1;
   8362c:	12800000 	mov	w0, #0xffffffff            	// #-1
   83630:	b8337aa0 	str	w0, [x21, x19, lsl #2]
   83634:	a9425bf5 	ldp	x21, x22, [sp, #32]
   ...
   83638:	a94153f3 	ldp	x19, x20, [sp, #16]
   8363c:	a8c47bfd 	ldp	x29, x30, [sp], #64
   83640:	d65f03c0 	ret
   83644:	d0000013 	adrp	x19, 85000 <get_el+0x61c>
   83648:	d0000016 	adrp	x22, 85000 <get_el+0x61c>
                W("ktimer_cancel idx %d", i+1); 
   8364c:	d0000015 	adrp	x21, 85000 <get_el+0x61c>
   83650:	913cc273 	add	x19, x19, #0xf30
   83654:	910ea2b5 	add	x21, x21, #0x3a8
   83658:	a90363f7 	stp	x23, x24, [sp, #48]
                BUG_ON(ret == -1); // no such timer
   8365c:	910642d8 	add	x24, x22, #0x190
        for (int i=0;i<N_TIMERS_TEST;i++) {
   83660:	52800014 	mov	w20, #0x0                   	// #0
                timers[i]=-1;
   83664:	12800017 	mov	w23, #0xffffffff            	// #-1
            if (timers[i]!=-1) {
   83668:	b9400260 	ldr	w0, [x19]
   8366c:	11000694 	add	w20, w20, #0x1
   83670:	3100041f 	cmn	w0, #0x1
   83674:	54000140 	b.eq	8369c <test_ktimer2+0xd4>  // b.none
                ret = ktimer_cancel(timers[i]); 
   83678:	97fffae8 	bl	82218 <ktimer_cancel>
                BUG_ON(ret == -1); // no such timer
   8367c:	3100041f 	cmn	w0, #0x1
   83680:	54000500 	b.eq	83720 <test_ktimer2+0x158>  // b.none
                timers[i]=-1;
   83684:	b9000277 	str	w23, [x19]
                W("ktimer_cancel idx %d", i+1); 
   83688:	2a1403e3 	mov	w3, w20
   8368c:	910642c1 	add	x1, x22, #0x190
   83690:	aa1503e0 	mov	x0, x21
   83694:	52800ba2 	mov	w2, #0x5d                  	// #93
   83698:	97fff7c4 	bl	815a8 <tfp_printf>
        for (int i=0;i<N_TIMERS_TEST;i++) {
   8369c:	91001273 	add	x19, x19, #0x4
   836a0:	7100269f 	cmp	w20, #0x9
   836a4:	54fffe21 	b.ne	83668 <test_ktimer2+0xa0>  // b.any
}
   836a8:	a94153f3 	ldp	x19, x20, [sp, #16]
   836ac:	a9425bf5 	ldp	x21, x22, [sp, #32]
   836b0:	a94363f7 	ldp	x23, x24, [sp, #48]
   836b4:	a8c47bfd 	ldp	x29, x30, [sp], #64
   836b8:	d65f03c0 	ret
            W("ktimer_start %d", idx+1); 
   836bc:	d0000015 	adrp	x21, 85000 <get_el+0x61c>
   836c0:	910642b5 	add	x21, x21, #0x190
   836c4:	2a1403e3 	mov	w3, w20
   836c8:	aa1503e1 	mov	x1, x21
   836cc:	52800d02 	mov	w2, #0x68                  	// #104
   836d0:	d0000000 	adrp	x0, 85000 <get_el+0x61c>
   836d4:	910fe000 	add	x0, x0, #0x3f8
   836d8:	97fff7b4 	bl	815a8 <tfp_printf>
                test_ktimer2_handler, (void*)colors[idx] /*args*/, 0 /* context */); 
   836dc:	f0000002 	adrp	x2, 86000 <_binary_font_psf_start+0xac>
   836e0:	91218042 	add	x2, x2, #0x860
            ret = ktimer_start(200*(idx+1), /*firing interval, ms*/
   836e4:	52801900 	mov	w0, #0xc8                  	// #200
   836e8:	90000001 	adrp	x1, 83000 <sys_timer_irq_simple+0x18>
   836ec:	d2800003 	mov	x3, #0x0                   	// #0
   836f0:	910dc021 	add	x1, x1, #0x370
   836f4:	1b007e80 	mul	w0, w20, w0
   836f8:	f8737842 	ldr	x2, [x2, x19, lsl #3]
   836fc:	97fffa7f 	bl	820f8 <ktimer_start>
   83700:	2a0003f4 	mov	w20, w0
            BUG_ON(ret<0); 
   83704:	37f801a0 	tbnz	w0, #31, 83738 <test_ktimer2+0x170>
            timers[idx]=ret; 
   83708:	913cc2d6 	add	x22, x22, #0xf30
   8370c:	b8337ad4 	str	w20, [x22, x19, lsl #2]
}
   83710:	a94153f3 	ldp	x19, x20, [sp, #16]
            timers[idx]=ret; 
   83714:	a9425bf5 	ldp	x21, x22, [sp, #32]
}
   83718:	a8c47bfd 	ldp	x29, x30, [sp], #64
   8371c:	d65f03c0 	ret
                BUG_ON(ret == -1); // no such timer
   83720:	aa1803e1 	mov	x1, x24
   83724:	d0000000 	adrp	x0, 85000 <get_el+0x61c>
   83728:	52800b62 	mov	w2, #0x5b                  	// #91
   8372c:	910e6000 	add	x0, x0, #0x398
   83730:	97fff86c 	bl	818e0 <assertion_failed>
   83734:	17ffffd4 	b	83684 <test_ktimer2+0xbc>
            BUG_ON(ret<0); 
   83738:	aa1503e1 	mov	x1, x21
   8373c:	d0000000 	adrp	x0, 85000 <get_el+0x61c>
   83740:	52800d62 	mov	w2, #0x6b                  	// #107
   83744:	9105a000 	add	x0, x0, #0x168
   83748:	97fff866 	bl	818e0 <assertion_failed>
   8374c:	17ffffef 	b	83708 <test_ktimer2+0x140>

0000000000083750 <test_fb_voffset>:
    efficiency.
...
void test_fb_voffset() {
   83750:	a9be7bfd 	stp	x29, x30, [sp, #-32]!
   83754:	910003fd 	mov	x29, sp
   83758:	f9000bf3 	str	x19, [sp, #16]
    ...
    the_fb.width = N;
   8375c:	f0000013 	adrp	x19, 86000 <_binary_font_psf_start+0xac>
    fb_fini(); 
   83760:	97fffbb8 	bl	82640 <fb_fini>
    the_fb.width = N;
   83764:	f9441a60 	ldr	x0, [x19, #2096]
   83768:	b21803e2 	mov	x2, #0x10000000100         	// #1099511628032
    the_fb.height = N;

    the_fb.vwidth = N*2; 
   8376c:	b21703e1 	mov	x1, #0x20000000200         	// #2199023256064
   83770:	a9008402 	stp	x2, x1, [x0, #8]
    the_fb.vheight = N*2; 

    if (fb_init() != 0) BUG();     
   83774:	97fffc5b 	bl	828e0 <fb_init>
   83778:	350008e0 	cbnz	w0, 83894 <test_fb_voffset+0x144>

    // prefill the fb with four color tiles, once 
    PIXEL b=0x00ff0000, g=0x0000ff00, r=0x000000ff; 
    int x, y;
    int pitch = the_fb.pitch; 
   8377c:	f9441a73 	ldr	x19, [x19, #2096]
    for (y=0;y<N;y++)
        for (x=0;x<N;x++)
            setpixel(the_fb.fb,x,y,pitch,r); 
   83780:	52802006 	mov	w6, #0x100                 	// #256
    *(PIXEL *)(buf + y*pit + x*PIXELSIZE) = p; 
   83784:	52801fe4 	mov	w4, #0xff                  	// #255
   83788:	f9400267 	ldr	x7, [x19]
    int pitch = the_fb.pitch; 
   8378c:	b9401a61 	ldr	w1, [x19, #24]
    for (y=0;y<N;y++)
   83790:	911000e2 	add	x2, x7, #0x400
            setpixel(the_fb.fb,x,y,pitch,r); 
   83794:	aa0203e3 	mov	x3, x2
   83798:	93407c25 	sxtw	x5, w1
        for (x=0;x<N;x++)
   8379c:	d1100060 	sub	x0, x3, #0x400
    *(PIXEL *)(buf + y*pit + x*PIXELSIZE) = p; 
   837a0:	b8004404 	str	w4, [x0], #4
        for (x=0;x<N;x++)
   837a4:	eb03001f 	cmp	x0, x3
   837a8:	54ffffc1 	b.ne	837a0 <test_fb_voffset+0x50>  // b.any
    for (y=0;y<N;y++)
   837ac:	8b050003 	add	x3, x0, x5
   837b0:	710004c6 	subs	w6, w6, #0x1
   837b4:	54ffff41 	b.ne	8379c <test_fb_voffset+0x4c>  // b.any
   837b8:	912000e7 	add	x7, x7, #0x800
   837bc:	52802006 	mov	w6, #0x100                 	// #256
   837c0:	aa0703e3 	mov	x3, x7
    *(PIXEL *)(buf + y*pit + x*PIXELSIZE) = p; 
   837c4:	32009fe4 	mov	w4, #0xff00ff              	// #16711935

    for (y=0;y<N;y++)
        for (x=N;x<2*N;x++)
   837c8:	d1100060 	sub	x0, x3, #0x400
   837cc:	d503201f 	nop
    *(PIXEL *)(buf + y*pit + x*PIXELSIZE) = p; 
   837d0:	b8004404 	str	w4, [x0], #4
        for (x=N;x<2*N;x++)
   837d4:	eb00007f 	cmp	x3, x0
   837d8:	54ffffc1 	b.ne	837d0 <test_fb_voffset+0x80>  // b.any
    for (y=0;y<N;y++)
   837dc:	8b050063 	add	x3, x3, x5
   837e0:	710004c6 	subs	w6, w6, #0x1
   837e4:	54ffff21 	b.ne	837c8 <test_fb_voffset+0x78>  // b.any
   837e8:	53185c21 	lsl	w1, w1, #8
   837ec:	52802004 	mov	w4, #0x100                 	// #256
    *(PIXEL *)(buf + y*pit + x*PIXELSIZE) = p; 
   837f0:	529fe003 	mov	w3, #0xff00                	// #65280
   837f4:	93407c21 	sxtw	x1, w1
   837f8:	8b020022 	add	x2, x1, x2
            setpixel(the_fb.fb,x,y,pitch,(b|r));             

    for (y=N;y<2*N;y++)
        for (x=0;x<N;x++)
   837fc:	d1100040 	sub	x0, x2, #0x400
    *(PIXEL *)(buf + y*pit + x*PIXELSIZE) = p; 
   83800:	b8004403 	str	w3, [x0], #4
        for (x=0;x<N;x++)
   83804:	eb00005f 	cmp	x2, x0
   83808:	54ffffc1 	b.ne	83800 <test_fb_voffset+0xb0>  // b.any
    for (y=N;y<2*N;y++)
   8380c:	8b050042 	add	x2, x2, x5
   83810:	71000484 	subs	w4, w4, #0x1
   83814:	54ffff41 	b.ne	837fc <test_fb_voffset+0xac>  // b.any
   83818:	8b070021 	add	x1, x1, x7
   8381c:	52802003 	mov	w3, #0x100                 	// #256
    *(PIXEL *)(buf + y*pit + x*PIXELSIZE) = p; 
   83820:	52a01fe2 	mov	w2, #0xff0000              	// #16711680
            setpixel(the_fb.fb,x,y,pitch,g); 

    for (y=N;y<2*N;y++)
        for (x=N;x<2*N;x++)
   83824:	d1100020 	sub	x0, x1, #0x400
    *(PIXEL *)(buf + y*pit + x*PIXELSIZE) = p; 
   83828:	b8004402 	str	w2, [x0], #4
        for (x=N;x<2*N;x++)
   8382c:	eb00003f 	cmp	x1, x0
   83830:	54ffffc1 	b.ne	83828 <test_fb_voffset+0xd8>  // b.any
    for (y=N;y<2*N;y++)
   83834:	8b050021 	add	x1, x1, x5
   83838:	71000463 	subs	w3, w3, #0x1
   8383c:	54ffff41 	b.ne	83824 <test_fb_voffset+0xd4>  // b.any
    ...
    while (1) {
        fb_set_voffsets(0,0);
   83840:	52800001 	mov	w1, #0x0                   	// #0
   83844:	52800000 	mov	w0, #0x0                   	// #0
   83848:	97fffb44 	bl	82558 <fb_set_voffsets>
        ms_delay(1500); 
   8384c:	5280bb80 	mov	w0, #0x5dc                 	// #1500
   83850:	97fff9d8 	bl	81fb0 <ms_delay>
        fb_set_voffsets(0,N);
   83854:	52802001 	mov	w1, #0x100                 	// #256
   83858:	52800000 	mov	w0, #0x0                   	// #0
   8385c:	97fffb3f 	bl	82558 <fb_set_voffsets>
        ms_delay(1500); 
   83860:	5280bb80 	mov	w0, #0x5dc                 	// #1500
   83864:	97fff9d3 	bl	81fb0 <ms_delay>
        fb_set_voffsets(N,0);
   83868:	52800001 	mov	w1, #0x0                   	// #0
   8386c:	52802000 	mov	w0, #0x100                 	// #256
   83870:	97fffb3a 	bl	82558 <fb_set_voffsets>
        ms_delay(1500); 
   83874:	5280bb80 	mov	w0, #0x5dc                 	// #1500
   83878:	97fff9ce 	bl	81fb0 <ms_delay>
        fb_set_voffsets(N,N);
   8387c:	52802001 	mov	w1, #0x100                 	// #256
   83880:	2a0103e0 	mov	w0, w1
   83884:	97fffb35 	bl	82558 <fb_set_voffsets>
        ms_delay(1500); 
   83888:	5280bb80 	mov	w0, #0x5dc                 	// #1500
   8388c:	97fff9c9 	bl	81fb0 <ms_delay>
    while (1) {
   83890:	17ffffec 	b	83840 <test_fb_voffset+0xf0>
    if (fb_init() != 0) BUG();     
   83894:	d0000001 	adrp	x1, 85000 <get_el+0x61c>
   83898:	b0000000 	adrp	x0, 84000 <vectors>
   8389c:	91064021 	add	x1, x1, #0x190
   838a0:	912ac000 	add	x0, x0, #0xab0
   838a4:	52801342 	mov	w2, #0x9a                  	// #154
   838a8:	97fff80e 	bl	818e0 <assertion_failed>
   838ac:	17ffffb4 	b	8377c <test_fb_voffset+0x2c>

00000000000838b0 <uart_send>:
// busy wait
...
void uart_send (char c) {
   ...
   838b0:	d28a0a82 	mov	x2, #0x5054                	// #20564
void uart_send (char c) {
   838b4:	12001c00 	and	w0, w0, #0xff
            if (get32(AUX_MU_LSR_REG) & 0x20)
   838b8:	f2a7e422 	movk	x2, #0x3f21, lsl #16
   838bc:	d503201f 	nop
   838c0:	b9400041 	ldr	w1, [x2]
   838c4:	362fffe1 	tbz	w1, #5, 838c0 <uart_send+0x10>
                break;
	}
	/* Q4  STUDENT_TODO: your code here */
    put32(AUX_MU_IO_REG, c);
   838c8:	d28a0801 	mov	x1, #0x5040                	// #20544
   838cc:	f2a7e421 	movk	x1, #0x3f21, lsl #16
   838d0:	b9000020 	str	w0, [x1]
}
   838d4:	d65f03c0 	ret

00000000000838d8 <uart_recv>:
 
// busy wait until get a char 
char uart_recv (void) {
	while(1) {
		if(get32(AUX_MU_LSR_REG) & 0x01) 
   838d8:	d28a0a81 	mov	x1, #0x5054                	// #20564
   838dc:	f2a7e421 	movk	x1, #0x3f21, lsl #16
   838e0:	b9400020 	ldr	w0, [x1]
   838e4:	3607ffe0 	tbz	w0, #0, 838e0 <uart_recv+0x8>
			break;
	}
	return(get32(AUX_MU_IO_REG) & 0xFF);
   838e8:	d28a0800 	mov	x0, #0x5040                	// #20544
   838ec:	f2a7e420 	movk	x0, #0x3f21, lsl #16
   838f0:	b9400000 	ldr	w0, [x0]
}
   838f4:	d65f03c0 	ret

00000000000838f8 <uart_try_recv>:

// try read a char, return -1 if no char (NB: return type is int) 
int uart_try_recv(void) {
    if (!(get32(AUX_MU_STAT_REG) & 0xF0000)) {
   838f8:	d28a0c80 	mov	x0, #0x5064                	// #20580
   838fc:	f2a7e420 	movk	x0, #0x3f21, lsl #16
   83900:	b9400000 	ldr	w0, [x0]
   83904:	72100c1f 	tst	w0, #0xf0000
   83908:	540000c0 	b.eq	83920 <uart_try_recv+0x28>  // b.none
        return -1;
    } else {
        // rx fifo has bytes
        return get32(AUX_MU_IO_REG) & 0xFF;
   8390c:	d28a0800 	mov	x0, #0x5040                	// #20544
   83910:	f2a7e420 	movk	x0, #0x3f21, lsl #16
   83914:	b9400000 	ldr	w0, [x0]
   83918:	12001c00 	and	w0, w0, #0xff
    }
}
   8391c:	d65f03c0 	ret
        return -1;
   83920:	12800000 	mov	w0, #0xffffffff            	// #-1
}
   83924:	d65f03c0 	ret

0000000000083928 <uart_send_string>:

void uart_send_string(char* str) {
	for (int i = 0; str[i] != '\0'; i ++) {
   83928:	39400002 	ldrb	w2, [x0]
   8392c:	34000182 	cbz	w2, 8395c <uart_send_string+0x34>
            if (get32(AUX_MU_LSR_REG) & 0x20)
   83930:	d28a0a81 	mov	x1, #0x5054                	// #20564
    put32(AUX_MU_IO_REG, c);
   83934:	d28a0804 	mov	x4, #0x5040                	// #20544
   83938:	91000403 	add	x3, x0, #0x1
            if (get32(AUX_MU_LSR_REG) & 0x20)
   8393c:	f2a7e421 	movk	x1, #0x3f21, lsl #16
    put32(AUX_MU_IO_REG, c);
   83940:	f2a7e424 	movk	x4, #0x3f21, lsl #16
   83944:	d503201f 	nop
            if (get32(AUX_MU_LSR_REG) & 0x20)
   83948:	b9400020 	ldr	w0, [x1]
   8394c:	362fffe0 	tbz	w0, #5, 83948 <uart_send_string+0x20>
    put32(AUX_MU_IO_REG, c);
   83950:	b9000082 	str	w2, [x4]
	for (int i = 0; str[i] != '\0'; i ++) {
   83954:	38401462 	ldrb	w2, [x3], #1
   83958:	35ffff82 	cbnz	w2, 83948 <uart_send_string+0x20>
		uart_send((char)str[i]);
	}
}
   8395c:	d65f03c0 	ret

0000000000083960 <putc>:
            if (get32(AUX_MU_LSR_REG) & 0x20)
   83960:	d28a0a82 	mov	x2, #0x5054                	// #20564

// This function is required by printf function
void putc(void* p, char c) {
   83964:	12001c21 	and	w1, w1, #0xff
            if (get32(AUX_MU_LSR_REG) & 0x20)
   83968:	f2a7e422 	movk	x2, #0x3f21, lsl #16
   8396c:	d503201f 	nop
   83970:	b9400040 	ldr	w0, [x2]
   83974:	362fffe0 	tbz	w0, #5, 83970 <putc+0x10>
    put32(AUX_MU_IO_REG, c);
   83978:	d28a0800 	mov	x0, #0x5040                	// #20544
   8397c:	f2a7e420 	movk	x0, #0x3f21, lsl #16
   83980:	b9000001 	str	w1, [x0]
	uart_send(c);
}
   83984:	d65f03c0 	ret

0000000000083988 <uart_irq>:
 */
void uart_irq(void) {
   ...
   83988:	d28a0900 	mov	x0, #0x5048                	// #20552
   8398c:	f2a7e420 	movk	x0, #0x3f21, lsl #16
   83990:	b9400000 	ldr	w0, [x0]
    if (iir & 1) // no pending
   83994:	37000060 	tbnz	w0, #0, 839a0 <uart_irq+0x18>
        return;
    V("pending irq: p %d w %d r %d", (iir & 1), (iir & 2), (iir & 4));

    // clear rx irq, must be done before we read 
    if (IS_RECEIVE_INTERRUPT(iir)) {
   83998:	36100040 	tbz	w0, #2, 839a0 <uart_irq+0x18>
        while (1) {
   8399c:	14000000 	b	8399c <uart_irq+0x14>
                /* STUDENT_TODO: your code here */
			V("char %d", c); 
			/* STUDENT_TODO: your code here */
        }
...
void uart_init(void) {
   ...
   839a8:	d2800082 	mov	x2, #0x4                   	// #4
void uart_init(void) {
   839ac:	a9be7bfd 	stp	x29, x30, [sp, #-32]!
    selector = get32(GPFSEL1);
   839b0:	f2a7e402 	movk	x2, #0x3f20, lsl #16
void uart_init(void) {
   839b4:	910003fd 	mov	x29, sp
    selector = get32(GPFSEL1);
   839b8:	b9400041 	ldr	w1, [x2]
   ...
   839bc:	d2801283 	mov	x3, #0x94                  	// #148
   839c0:	f2a7e403 	movk	x3, #0x3f20, lsl #16
    selector |= 2 << 15;    // set alt5 for gpio15
   839c4:	52840004 	mov	w4, #0x2000                	// #8192
   839c8:	120e6421 	and	w1, w1, #0xfffc0fff
void uart_init(void) {
   839cc:	f9000bf3 	str	x19, [sp, #16]
    selector |= 2 << 15;    // set alt5 for gpio15
   839d0:	72a00024 	movk	w4, #0x1, lsl #16
   839d4:	2a040021 	orr	w1, w1, w4
    put32(GPFSEL1, selector);
   839d8:	b9000041 	str	w1, [x2]
    delay(150);
   ...
   839dc:	d2801313 	mov	x19, #0x98                  	// #152
    put32(GPPUD, 0); // disable pull up/down control (for pins below)
   839e0:	b900007f 	str	wzr, [x3]
    put32(GPPUDCLK0, (1 << 14) | (1 << 15)); // "clock the control signal into the GPIO pads"
   839e4:	f2a7e413 	movk	x19, #0x3f20, lsl #16
    delay(150);
   839e8:	d28012c0 	mov	x0, #0x96                  	// #150
   839ec:	97fff9ab 	bl	82098 <delay>
    put32(GPPUDCLK0, (1 << 14) | (1 << 15)); // "clock the control signal into the GPIO pads"
   839f0:	52980000 	mov	w0, #0xc000                	// #49152
   839f4:	b9000260 	str	w0, [x19]
    delay(150);
   839f8:	d28012c0 	mov	x0, #0x96                  	// #150
   839fc:	97fff9a7 	bl	82098 <delay>
    put32(GPPUDCLK0, 0);               // remote the clock, flush GPIO setup
   83a00:	b900027f 	str	wzr, [x19]
    put32(AUX_MU_IIR_REG, FLUSH_UART); // flush FIFO
   83a04:	d28a0902 	mov	x2, #0x5048                	// #20552

    put32(AUX_ENABLES, 1);     // Enable mini uart (this also enables access to it registers)
   83a08:	d28a0081 	mov	x1, #0x5004                	// #20484
    put32(AUX_MU_IIR_REG, FLUSH_UART); // flush FIFO
   83a0c:	f2a7e422 	movk	x2, #0x3f21, lsl #16
    put32(AUX_ENABLES, 1);     // Enable mini uart (this also enables access to it registers)
   83a10:	f2a7e421 	movk	x1, #0x3f21, lsl #16
    put32(AUX_MU_CNTL_REG, 0); // Disable auto flow control and disable receiver and transmitter (for now)
   83a14:	d28a0c00 	mov	x0, #0x5060                	// #20576
    put32(AUX_MU_IIR_REG, FLUSH_UART); // flush FIFO
   83a18:	528018c3 	mov	w3, #0xc6                  	// #198
    put32(AUX_MU_CNTL_REG, 0); // Disable auto flow control and disable receiver and transmitter (for now)
   83a1c:	f2a7e420 	movk	x0, #0x3f21, lsl #16
   ...
   83a20:	d28a0985 	mov	x5, #0x504c                	// #20556
    put32(AUX_MU_MCR_REG, 0);    // Set RTS line to be always high
    put32(AUX_MU_BAUD_REG, 270); // Set baud rate to 115200

    put32(AUX_MU_CNTL_REG, 3); // Finally, enable transmitter and receiver
}
   83a24:	f9400bf3 	ldr	x19, [sp, #16]
    put32(AUX_MU_IIR_REG, FLUSH_UART); // flush FIFO
   83a28:	b9000043 	str	w3, [x2]
    put32(AUX_MU_IER_REG, (3 << 2) | (0xf << 4)); // bit 7:4 3:2 must be 1
   83a2c:	d28a0882 	mov	x2, #0x5044                	// #20548
    put32(AUX_ENABLES, 1);     // Enable mini uart (this also enables access to it registers)
   83a30:	52800023 	mov	w3, #0x1                   	// #1
    put32(AUX_MU_IER_REG, (3 << 2) | (0xf << 4)); // bit 7:4 3:2 must be 1
   83a34:	f2a7e422 	movk	x2, #0x3f21, lsl #16
    put32(AUX_ENABLES, 1);     // Enable mini uart (this also enables access to it registers)
   83a38:	b9000023 	str	w3, [x1]
    put32(AUX_MU_CNTL_REG, 0); // Disable auto flow control and disable receiver and transmitter (for now)
   83a3c:	b900001f 	str	wzr, [x0]
    put32(AUX_MU_LCR_REG, 3);    // Enable 8 bit mode
   83a40:	f2a7e425 	movk	x5, #0x3f21, lsl #16
    put32(AUX_MU_IER_REG, (3 << 2) | (0xf << 4)); // bit 7:4 3:2 must be 1
   83a44:	52801f81 	mov	w1, #0xfc                  	// #252
    put32(AUX_MU_MCR_REG, 0);    // Set RTS line to be always high
   83a48:	d28a0a04 	mov	x4, #0x5050                	// #20560
    put32(AUX_MU_IER_REG, (3 << 2) | (0xf << 4)); // bit 7:4 3:2 must be 1
   83a4c:	b9000041 	str	w1, [x2]
    put32(AUX_MU_MCR_REG, 0);    // Set RTS line to be always high
   83a50:	f2a7e424 	movk	x4, #0x3f21, lsl #16
    put32(AUX_MU_BAUD_REG, 270); // Set baud rate to 115200
   83a54:	d28a0d03 	mov	x3, #0x5068                	// #20584
    put32(AUX_MU_LCR_REG, 3);    // Enable 8 bit mode
   83a58:	52800061 	mov	w1, #0x3                   	// #3
		unsigned int ier = get32(AUX_MU_IER_REG); 
   83a5c:	b9400042 	ldr	w2, [x2]
    put32(AUX_MU_BAUD_REG, 270); // Set baud rate to 115200
   83a60:	f2a7e423 	movk	x3, #0x3f21, lsl #16
    put32(AUX_MU_LCR_REG, 3);    // Enable 8 bit mode
   83a64:	b90000a1 	str	w1, [x5]
    put32(AUX_MU_MCR_REG, 0);    // Set RTS line to be always high
   83a68:	b900009f 	str	wzr, [x4]
    put32(AUX_MU_BAUD_REG, 270); // Set baud rate to 115200
   83a6c:	528021c2 	mov	w2, #0x10e                 	// #270
   83a70:	b9000062 	str	w2, [x3]
    put32(AUX_MU_CNTL_REG, 3); // Finally, enable transmitter and receiver
   83a74:	b9000001 	str	w1, [x0]
}
